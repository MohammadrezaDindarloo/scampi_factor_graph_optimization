...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl2(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp10 = _tmp3 * rot_init_z - _tmp6 * rot_init_y + _tmp7 * ry + _tmp9 * rot_init_w;
  ...
  const Scalar _tmp14 =
      2 * _tmp3 * rot_init_w - 2 * _tmp5 * rot_init_y - 2 * _tmp7 * rx - 2 * _tmp9 * rot_init_z;
  ...
  const Scalar _tmp25 = 2 * _tmp13 * _tmp8;
  const Scalar _tmp26 = _tmp10 * _tmp14;
  ...
  const Scalar _tmp31 = Scalar(0.20999999999999999) * _tmp18 + Scalar(0.20999999999999999) * _tmp30;
  ...
  const Scalar _tmp36 = Scalar(0.20999999999999999) * _tmp17 +
                        Scalar(0.20999999999999999) * _tmp30 + Scalar(0.20999999999999999);
  const Scalar _tmp37 =
      -Scalar(0.010999999999999999) * _tmp12 + Scalar(0.010999999999999999) * _tmp15;
  const Scalar _tmp38 = -_tmp36 + _tmp37;
  const Scalar _tmp39 = _tmp35 + _tmp38;
  const Scalar _tmp40 = _tmp39 + p_init1 + Scalar(8.3888750099999996);
  const Scalar _tmp41 = std::pow(Scalar(std::pow(_tmp34, Scalar(2)) + std::pow(_tmp40, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp42 = _tmp40 * _tmp41;
  const Scalar _tmp43 = _tmp27 + _tmp32;
  ...
  const Scalar _tmp63 = _tmp49 * _tmp61 - _tmp62;
  const Scalar _tmp64 = Scalar(1.0) / (-_tmp42 + _tmp49 * _tmp51);
  const Scalar _tmp65 = _tmp63 * _tmp64;
  const Scalar _tmp66 = _tmp16 + _tmp19 - _tmp22;
  const Scalar _tmp67 = _tmp50 * _tmp61;
  const Scalar _tmp68 = Scalar(1.0) * _tmp47;
  const Scalar _tmp69 = Scalar(1.0) * _tmp43;
  const Scalar _tmp70 = (-_tmp33 + _tmp69) / (_tmp39 - _tmp68);
  const Scalar _tmp71 = -_tmp24 * _tmp51 + _tmp52;
  const Scalar _tmp72 = -_tmp61 * _tmp66 - _tmp65 * _tmp71 + _tmp67 -
                        _tmp70 * (-_tmp49 * _tmp67 - _tmp53 * _tmp65 + _tmp62 * _tmp66);
  const Scalar _tmp73 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp74 = _tmp68 * _tmp70 + _tmp69;
  ...
  const Scalar _tmp80 = _tmp78 * (_tmp43 * _tmp48 * _tmp79 - _tmp44 * _tmp47 * _tmp79);
  const Scalar _tmp81 = -_tmp33 * _tmp42 + _tmp39 * _tmp51 + _tmp51 * _tmp80;
  const Scalar _tmp82 = _tmp49 * _tmp64;
  const Scalar _tmp83 = -_tmp50 - _tmp70 * (_tmp49 * _tmp50 + _tmp53 * _tmp82) + _tmp71 * _tmp82;
  const Scalar _tmp84 = _tmp55 * _tmp61 - _tmp58 * _tmp62 + _tmp61 * _tmp80 - _tmp65 * _tmp81;
  const Scalar _tmp85 = _tmp73 * _tmp84;
  const Scalar _tmp86 = Scalar(1.0) / (_tmp84);
  const Scalar _tmp87 = _tmp72 * _tmp86;
  const Scalar _tmp88 = _tmp83 + _tmp87 * (-_tmp80 + _tmp81 * _tmp82 - _tmp83 * _tmp85);
  const Scalar _tmp89 = _tmp63 * _tmp73;
  const Scalar _tmp90 = -_tmp49 - _tmp88 * _tmp89;
  const Scalar _tmp91 = _tmp51 * _tmp64;
  const Scalar _tmp92 = _tmp61 * _tmp73;
  const Scalar _tmp93 = _tmp38 + _tmp54;
  const Scalar _tmp94 = _tmp93 + p_init1 + Scalar(8.3196563700000006);
  const Scalar _tmp95 = _tmp28 + _tmp57;
  ...
  const Scalar _tmp102 = fh1 * (_tmp101 * _tmp95 - _tmp93 * _tmp98);
  const Scalar _tmp103 = Scalar(1.0) * _tmp64;
  const Scalar _tmp104 = _tmp103 * _tmp53 * _tmp70 - _tmp103 * _tmp71;
  const Scalar _tmp105 = _tmp104 + _tmp87 * (-_tmp103 * _tmp81 - _tmp104 * _tmp85);
  const Scalar _tmp106 = -_tmp105 * _tmp89 + Scalar(1.0);
  const Scalar _tmp107 = _tmp101 * fh1;
  const Scalar _tmp108 = _tmp100 * _tmp102;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp78 * (_tmp61 * _tmp75 - _tmp75 * _tmp76) +
                        _tmp102 * _tmp78 * (_tmp100 * _tmp61 - _tmp100 * _tmp76) +
                        _tmp107 * _tmp78 * (_tmp105 * _tmp92 + _tmp106 * _tmp91) +
                        _tmp78 * _tmp99 * (_tmp88 * _tmp92 + _tmp90 * _tmp91 + Scalar(1.0)));
  _res(2, 0) = std::exp(-_tmp106 * _tmp107 * _tmp64 + _tmp108 * _tmp65 + _tmp109 * _tmp65 -
                        _tmp64 * _tmp90 * _tmp99);
  _res(3, 0) = std::exp(-_tmp105 * _tmp107 * _tmp73 - _tmp108 - _tmp109 - _tmp73 * _tmp88 * _tmp99);
