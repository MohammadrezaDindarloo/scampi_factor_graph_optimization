...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl1(
  ...
  const Scalar _tmp20 = 1 - 2 * std::pow(_tmp10, Scalar(2));
  ...
  const Scalar _tmp36 = -2 * std::pow(_tmp11, Scalar(2));
  const Scalar _tmp37 = Scalar(0.20999999999999999) * _tmp19 +
  ...
  const Scalar _tmp56 =
      -Scalar(0.010999999999999999) * _tmp20 - Scalar(0.010999999999999999) * _tmp36;
  const Scalar _tmp57 = Scalar(0.20999999999999999) * _tmp32 - Scalar(0.20999999999999999) * _tmp33;
  const Scalar _tmp58 = _tmp56 + _tmp57;
  const Scalar _tmp59 = _tmp55 + _tmp58;
  const Scalar _tmp60 = _tmp48 * _tmp51;
  const Scalar _tmp61 = _tmp59 * _tmp60;
  const Scalar _tmp62 = _tmp21 + _tmp26;
  ...
  const Scalar _tmp72 = Scalar(1.0) / (_tmp60 * _tmp70 - _tmp71);
  const Scalar _tmp73 = _tmp59 * _tmp70;
  const Scalar _tmp74 = _tmp56 - _tmp57;
  const Scalar _tmp75 = _tmp54 + _tmp74;
  const Scalar _tmp76 = _tmp72 * (-_tmp60 * _tmp73 + _tmp71 * _tmp75);
  const Scalar _tmp77 = _tmp60 * _tmp76 + _tmp61;
  ...
  const Scalar _tmp84 = _tmp72 * (-_tmp70 * _tmp75 + _tmp73);
  const Scalar _tmp85 = -_tmp59 + _tmp60 * _tmp84 - _tmp77 * _tmp83;
  const Scalar _tmp86 = _tmp17 + _tmp62;
  const Scalar _tmp87 = _tmp86 + p_init1;
  const Scalar _tmp88 = _tmp87 + Scalar(-4.7752063900000001);
  const Scalar _tmp89 = _tmp30 + _tmp42;
  ...
  const Scalar _tmp95 = _tmp60 * _tmp93 - _tmp94;
  const Scalar _tmp96 = _tmp54 + _tmp58;
  const Scalar _tmp97 = -_tmp61 * _tmp93 - _tmp76 * _tmp95 + _tmp94 * _tmp96;
  const Scalar _tmp98 = _tmp59 * _tmp93 - _tmp83 * _tmp97 - _tmp84 * _tmp95 - _tmp93 * _tmp96;
  const Scalar _tmp99 = Scalar(1.0) / (_tmp98);
  const Scalar _tmp100 = _tmp72 * (_tmp53 * _tmp70 + _tmp63 * _tmp70 - _tmp66 * _tmp71);
  const Scalar _tmp101 = -_tmp100 * _tmp95 + _tmp53 * _tmp93 + _tmp86 * _tmp93 - _tmp89 * _tmp94;
  const Scalar _tmp102 = _tmp101 * _tmp99;
  const Scalar _tmp103 = Scalar(1.0) / (_tmp101);
  const Scalar _tmp104 = _tmp103 * _tmp98;
  const Scalar _tmp105 = _tmp104 * (_tmp100 * _tmp60 - _tmp102 * _tmp85 - _tmp53);
  const Scalar _tmp106 = _tmp105 + _tmp85;
  const Scalar _tmp107 = _tmp97 * _tmp99;
  const Scalar _tmp108 = _tmp79 + _tmp86;
  const Scalar _tmp109 = _tmp108 * _tmp83;
  const Scalar _tmp110 = Scalar(1.0) / (-_tmp109 + _tmp81 - _tmp89);
  const Scalar _tmp111 = _tmp108 * _tmp110;
  const Scalar _tmp112 = _tmp105 * _tmp111 - _tmp106 * _tmp107 + _tmp77;
  const Scalar _tmp113 = Scalar(1.0) * _tmp80;
  const Scalar _tmp114 = Scalar(1.0) * _tmp110;
  const Scalar _tmp115 = _tmp29 + Scalar(8.3196563700000006);
  const Scalar _tmp116 = _tmp40 + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp120 = _tmp113 * _tmp76 * _tmp82 - Scalar(1.0) * _tmp84;
  const Scalar _tmp121 = _tmp104 * (-Scalar(1.0) * _tmp100 - _tmp102 * _tmp120);
  const Scalar _tmp122 = _tmp120 + _tmp121;
  const Scalar _tmp123 = -_tmp107 * _tmp122 + _tmp111 * _tmp121 - Scalar(1.0) * _tmp76;
  const Scalar _tmp124 = _tmp115 * _tmp117;
  const Scalar _tmp125 = _tmp124 * fh1;
  const Scalar _tmp126 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp127 = _tmp78 * _tmp83 + _tmp81;
  const Scalar _tmp128 = _tmp110 * _tmp127;
  const Scalar _tmp129 = 0;
  const Scalar _tmp130 = _tmp80 * (-_tmp108 * _tmp128 - _tmp129 * _tmp97 + _tmp79);
  const Scalar _tmp131 = -Scalar(1.0) * _tmp114 * _tmp127 - Scalar(1.0) * _tmp130 + Scalar(1.0);
  const Scalar _tmp132 = fh1 * (_tmp55 + _tmp74);
  const Scalar _tmp133 = -_tmp124 * _tmp132 - Scalar(3.29616) * _tmp24 - _tmp28 * fv1;
  const Scalar _tmp134 = _tmp80 * (_tmp109 * _tmp114 + Scalar(1.0));
  const Scalar _tmp135 = _tmp114 * _tmp83;
  const Scalar _tmp136 = -Scalar(1.0) * _tmp134 + Scalar(1.0) * _tmp135;
  const Scalar _tmp137 = _tmp104 * _tmp114;
  const Scalar _tmp138 = Scalar(1.0) * _tmp103;
  const Scalar _tmp139 = _tmp108 * _tmp137 - _tmp138 * _tmp97;
  const Scalar _tmp140 = fh1 * (-_tmp118 * _tmp28 + _tmp124 * _tmp39);
  const Scalar _tmp141 = _tmp118 * _tmp132 + Scalar(3.29616) * _tmp34 + _tmp39 * fv1;
  const Scalar _tmp142 = _tmp108 * _tmp80;
  const Scalar _tmp143 = Scalar(1.0) * _tmp114 * _tmp142 - Scalar(1.0) * _tmp114;
  const Scalar _tmp144 = Scalar(1.0) * _tmp119 * (_tmp105 * _tmp114 - _tmp112 * _tmp113) +
                         Scalar(1.0) * _tmp125 * (-_tmp113 * _tmp123 + _tmp114 * _tmp121) +
                         _tmp126 * _tmp131 + _tmp133 * _tmp136 +
                         Scalar(1.0) * _tmp140 * (-_tmp113 * _tmp139 + _tmp137) + _tmp141 * _tmp143;
  const Scalar _tmp145 = _tmp95 * _tmp99;
  const Scalar _tmp146 = -_tmp122 * _tmp145 + Scalar(1.0);
  const Scalar _tmp147 = _tmp70 * _tmp72;
  const Scalar _tmp148 = _tmp93 * _tmp99;
  const Scalar _tmp149 = _tmp147 * _tmp95;
  const Scalar _tmp150 = -_tmp106 * _tmp145 - _tmp60;
  const Scalar _tmp151 = _tmp52 * (-_tmp129 * _tmp149 + _tmp129 * _tmp93);
  const Scalar _tmp152 = -_tmp119 * _tmp52 * (_tmp106 * _tmp148 + _tmp147 * _tmp150 + Scalar(1.0)) -
                         _tmp125 * _tmp52 * (_tmp122 * _tmp148 + _tmp146 * _tmp147) -
                         _tmp126 * _tmp151 -
                         _tmp140 * _tmp52 * (-_tmp138 * _tmp149 + _tmp138 * _tmp93);
  ...
  const Scalar _tmp157 = _tmp17 + _tmp21 + _tmp25;
  const Scalar _tmp158 = _tmp151 * _tmp156;
  const Scalar _tmp159 =
      (-_tmp144 * _tmp158 + _tmp153 * (-_tmp131 + _tmp136 * _tmp157 + _tmp143 * _tmp39)) /
      std::sqrt(Scalar(std::pow(_tmp144, Scalar(2)) * _tmp156 + 1));
  const Scalar _tmp160 = Scalar(9.6622558468725703) * _tmp152;
  ...
  const Scalar _tmp162 = Scalar(0.1034955) * _tmp153;
  const Scalar _tmp163 = _tmp161 * _tmp162;
  const Scalar _tmp164 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp165 = _tmp138 * _tmp140;
  const Scalar _tmp166 = _tmp72 * _tmp95;
  const Scalar _tmp167 = _tmp126 * _tmp129;
  const Scalar _tmp168 = _tmp119 * _tmp150 * _tmp72 + _tmp125 * _tmp146 * _tmp72 -
                         _tmp165 * _tmp166 - _tmp166 * _tmp167;
  const Scalar _tmp169 = Scalar(1.0) / (_tmp168);
  const Scalar _tmp170 = _tmp114 * _tmp141;
  const Scalar _tmp171 = _tmp112 * _tmp119 * _tmp80 + _tmp123 * _tmp125 * _tmp80 +
                         _tmp126 * _tmp130 + _tmp133 * _tmp134 + _tmp139 * _tmp140 * _tmp80 -
                         _tmp142 * _tmp170;
  ...
  const Scalar _tmp181 = _tmp114 * _tmp39;
  const Scalar _tmp182 = _tmp129 * _tmp166 * _tmp180;
  const Scalar _tmp183 =
      (_tmp169 * (-_tmp130 + _tmp134 * _tmp157 - _tmp142 * _tmp181) - _tmp171 * _tmp182) /
      std::sqrt(Scalar(std::pow(_tmp171, Scalar(2)) * _tmp180 + 1));
  const Scalar _tmp184 = -_tmp105 * _tmp110 * _tmp119 - _tmp110 * _tmp121 * _tmp125 +
                         _tmp126 * _tmp128 - _tmp133 * _tmp135 - _tmp137 * _tmp140 + _tmp170;
  const Scalar _tmp185 =
      _tmp106 * _tmp119 * _tmp99 + _tmp122 * _tmp125 * _tmp99 + _tmp165 + _tmp167;
  ...
  const Scalar _tmp195 = (_tmp184 * _tmp194 + _tmp186 * (-_tmp128 - _tmp135 * _tmp157 + _tmp181)) /
  ...
  _res(1, 0) = _tmp160 * (-Scalar(1.0) * _tmp159 * std::cosh(_tmp155) -
                          (-Scalar(0.1034955) * _tmp158 * _tmp161 +
                           _tmp162 * (-_tmp154 * _tmp164 - _tmp159 * _tmp160)) *
                              std::cosh(_tmp163)) +
               _tmp164 * (-std::sinh(_tmp155) - std::sinh(_tmp163));
  ...
  _res(3, 0) = -_tmp178 * (-std::sinh(_tmp191) - std::sinh(_tmp192)) +
               _tmp188 * (-Scalar(1.0) * _tmp195 * std::cosh(_tmp192) -
                          (Scalar(0.1034955) * _tmp189 * _tmp194 +
                           _tmp190 * (_tmp178 * _tmp187 - _tmp188 * _tmp195)) *
                              std::cosh(_tmp191));
