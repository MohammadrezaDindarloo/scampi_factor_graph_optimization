...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl14(
  ...
  const Scalar _tmp23 = _tmp12 * _tmp16;
  const Scalar _tmp24 = _tmp10 * _tmp19;
  ...
  const Scalar _tmp31 = 2 * _tmp10 * _tmp12;
  ...
  const Scalar _tmp44 = _tmp34 - _tmp35;
  ...
  const Scalar _tmp80 = -_tmp68 * _tmp79 + _tmp70 * _tmp78;
  const Scalar _tmp81 = Scalar(1.0) / (_tmp53 * _tmp79 - _tmp78);
  const Scalar _tmp82 = _tmp65 * _tmp81;
  const Scalar _tmp83 = _tmp42 + _tmp69;
  const Scalar _tmp84 = -_tmp63 * _tmp68 + _tmp64 * _tmp83 - _tmp80 * _tmp82;
  const Scalar _tmp85 = Scalar(1.0) * _tmp45;
  const Scalar _tmp86 = Scalar(1.0) * _tmp50;
  const Scalar _tmp87 = -_tmp86;
  const Scalar _tmp88 = Scalar(1.0) / (_tmp71 + _tmp87);
  const Scalar _tmp89 = _tmp88 * (-_tmp74 + _tmp85);
  const Scalar _tmp90 = _tmp67 * _tmp79 - _tmp70 * _tmp79;
  const Scalar _tmp91 = _tmp63 * _tmp67 - _tmp63 * _tmp83 - _tmp82 * _tmp90 - _tmp84 * _tmp89;
  ...
  const Scalar _tmp97 = _tmp71 * _tmp79 - _tmp74 * _tmp78 + _tmp79 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) * _tmp81;
  const Scalar _tmp99 = _tmp80 * _tmp98;
  const Scalar _tmp100 = _tmp89 * _tmp99 - _tmp90 * _tmp98;
  const Scalar _tmp101 = _tmp55 * _tmp63 - _tmp59 * _tmp64 + _tmp63 * _tmp96 - _tmp82 * _tmp97;
  ...
  const Scalar _tmp107 = -_tmp106 * _tmp65 + Scalar(1.0);
  const Scalar _tmp108 = _tmp79 * _tmp81;
  const Scalar _tmp109 = _tmp28 + Scalar(-4.7752063900000001);
  const Scalar _tmp110 = _tmp38 + Scalar(-2.71799795);
  ...
  const Scalar _tmp114 = _tmp103 * _tmp65 * _tmp98;
  const Scalar _tmp115 = Scalar(1.0) * _tmp103;
  const Scalar _tmp116 = _tmp110 * _tmp111;
  const Scalar _tmp117 = fh1 * (_tmp112 * _tmp37 - _tmp116 * _tmp27);
  const Scalar _tmp118 = _tmp53 * _tmp81;
  const Scalar _tmp119 = _tmp118 * _tmp80 + _tmp68;
  const Scalar _tmp120 = _tmp118 * _tmp90 - _tmp119 * _tmp89 - _tmp67;
  const Scalar _tmp121 = _tmp104 * (-_tmp102 * _tmp120 + _tmp118 * _tmp97 - _tmp96);
  const Scalar _tmp122 = _tmp92 * (_tmp120 + _tmp121);
  const Scalar _tmp123 = -_tmp122 * _tmp65 - _tmp53;
  const Scalar _tmp124 = _tmp116 * fh1;
  const Scalar _tmp125 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp126 = _tmp85 + _tmp86 * _tmp89;
  const Scalar _tmp127 = 0;
  const Scalar _tmp128 = -_tmp113 * _tmp95 * (_tmp106 * _tmp63 + _tmp107 * _tmp108) -
                         _tmp117 * _tmp95 * (-_tmp114 * _tmp79 + _tmp115 * _tmp63) -
                         _tmp124 * _tmp95 * (_tmp108 * _tmp123 + _tmp122 * _tmp63 + Scalar(1.0)) -
                         _tmp125 * _tmp95 * (_tmp127 * _tmp63 - _tmp127 * _tmp79 * _tmp82);
  const Scalar _tmp129 = Scalar(1.0) / (_tmp128);
  const Scalar _tmp130 = _tmp55 + _tmp87;
  const Scalar _tmp131 = _tmp130 * _tmp89;
  const Scalar _tmp132 = Scalar(1.0) / (-_tmp131 - _tmp59 + _tmp85);
  const Scalar _tmp133 = Scalar(1.0) * _tmp132;
  const Scalar _tmp134 = _tmp131 * _tmp133 + Scalar(1.0);
  const Scalar _tmp135 = Scalar(1.0) * _tmp88;
  const Scalar _tmp136 = _tmp133 * _tmp89;
  const Scalar _tmp137 = _tmp43 * fh1;
  const Scalar _tmp138 = -_tmp112 * _tmp137 - Scalar(3.29616) * _tmp21 - _tmp27 * fv1;
  const Scalar _tmp139 = _tmp130 * _tmp132;
  const Scalar _tmp140 = _tmp105 * _tmp139 - _tmp106 * _tmp84 - _tmp99;
  const Scalar _tmp141 = _tmp116 * _tmp137 + Scalar(3.29616) * _tmp33 + _tmp37 * fv1;
  const Scalar _tmp142 = _tmp130 * _tmp88;
  const Scalar _tmp143 = _tmp126 * _tmp132;
  const Scalar _tmp144 = -_tmp127 * _tmp84 - _tmp130 * _tmp143 + _tmp87;
  const Scalar _tmp145 = _tmp104 * _tmp133;
  const Scalar _tmp146 = -_tmp115 * _tmp84 + _tmp130 * _tmp145;
  const Scalar _tmp147 = _tmp119 + _tmp121 * _tmp139 - _tmp122 * _tmp84;
  const Scalar _tmp148 = std::asinh(
      _tmp129 * (Scalar(1.0) * _tmp113 * (_tmp105 * _tmp133 - _tmp135 * _tmp140) +
                 Scalar(1.0) * _tmp117 * (-_tmp135 * _tmp146 + _tmp145) +
                 Scalar(1.0) * _tmp124 * (_tmp121 * _tmp133 - _tmp135 * _tmp147) +
                 Scalar(1.0) * _tmp125 * (-_tmp126 * _tmp133 - _tmp135 * _tmp144 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp138 * (-_tmp134 * _tmp135 + _tmp136) +
                 Scalar(1.0) * _tmp141 * (_tmp133 * _tmp142 - _tmp133)));
  const Scalar _tmp149 = Scalar(9.6622558468725703) * _tmp128;
  const Scalar _tmp150 = _tmp125 * _tmp127;
  const Scalar _tmp151 = _tmp107 * _tmp113 * _tmp81 - _tmp114 * _tmp117 +
                         _tmp123 * _tmp124 * _tmp81 - _tmp150 * _tmp82;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = _tmp133 * _tmp141;
  const Scalar _tmp154 =
      std::asinh(_tmp152 * (_tmp113 * _tmp140 * _tmp88 + _tmp117 * _tmp146 * _tmp88 +
                            _tmp124 * _tmp147 * _tmp88 + _tmp125 * _tmp144 * _tmp88 +
                            _tmp134 * _tmp138 * _tmp88 - _tmp142 * _tmp153));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp156 = _tmp106 * _tmp113 + _tmp115 * _tmp117 + _tmp122 * _tmp124 + _tmp150;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 = std::asinh(_tmp157 * (-_tmp105 * _tmp113 * _tmp132 - _tmp117 * _tmp145 -
                                               _tmp121 * _tmp124 * _tmp132 + _tmp125 * _tmp143 -
                                               _tmp136 * _tmp138 + _tmp153));
  ...
  _res(1, 0) =
      -_tmp149 *
          (Scalar(0.87653584775870996) * _tmp129 + std::cosh(Scalar(1.0) * _tmp148) -
           std::cosh(
               Scalar(0.1034955) * _tmp129 *
               (-_tmp148 * _tmp149 -
                Scalar(8.3888750099999996) *
                    std::sqrt(Scalar(
                        Scalar(0.090254729040973036) *
                            std::pow(Scalar(1 - Scalar(0.39679052492160538) * _tmp46), Scalar(2)) +
                        std::pow(Scalar(-Scalar(0.11920549523123722) * _tmp51 - 1),
                                 Scalar(2))))))) +
      _tmp67 + p_init2;
  _res(2, 0) =
      -_tmp155 *
          (Scalar(0.87679799772039002) * _tmp152 + std::cosh(Scalar(1.0) * _tmp154) -
           std::cosh(
                ...
                Scalar(8.3196563700000006) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.057067943376852184) *
                            std::pow(Scalar(-Scalar(0.50315118556004401) * _tmp75 - 1),
                                     Scalar(2))))))) +
      _tmp70 + p_init2;
  _res(3, 0) =
      -_tmp159 *
          (Scalar(0.86625939559540499) * _tmp157 + std::cosh(Scalar(1.0) * _tmp158) -
           std::cosh(
