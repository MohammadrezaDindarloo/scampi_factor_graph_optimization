...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl9(
  ...
  const Scalar _tmp9 = _tmp3 * rz;
  const Scalar _tmp10 = _tmp2 * rot_init_z + _tmp4 * rot_init_x - _tmp6 * rx + _tmp9 * rot_init_w;
  ...
  const Scalar _tmp13 =
      _tmp2 * rot_init_y + _tmp4 * rot_init_w + _tmp5 * rot_init_z - _tmp9 * rot_init_x;
  const Scalar _tmp14 = 2 * _tmp10;
  const Scalar _tmp15 = _tmp13 * _tmp14;
  const Scalar _tmp16 =
      2 * _tmp2 * rot_init_w - 2 * _tmp5 * rot_init_x - 2 * _tmp6 * ry - 2 * _tmp9 * rot_init_z;
  const Scalar _tmp17 = _tmp16 * _tmp7;
  const Scalar _tmp18 =
      -Scalar(0.010999999999999999) * _tmp15 + Scalar(0.010999999999999999) * _tmp17;
  const Scalar _tmp19 = 2 * _tmp13 * _tmp7;
  const Scalar _tmp20 = _tmp10 * _tmp16;
  ...
  const Scalar _tmp25 = 1 - 2 * std::pow(_tmp13, Scalar(2));
  const Scalar _tmp26 = Scalar(0.20999999999999999) * _tmp11 + Scalar(0.20999999999999999) * _tmp25;
  const Scalar _tmp27 = _tmp14 * _tmp7;
  const Scalar _tmp28 = _tmp13 * _tmp16;
  const Scalar _tmp29 =
  ...
  const Scalar _tmp34 =
      std::sqrt(Scalar(std::pow(_tmp24, Scalar(2)) + std::pow(_tmp33, Scalar(2))));
  const Scalar _tmp35 = Scalar(1.0) / (_tmp34);
  const Scalar _tmp36 = Scalar(1.0) / (_tmp33);
  const Scalar _tmp37 = _tmp34 * _tmp36;
  const Scalar _tmp38 = _tmp37 * (-_tmp23 * _tmp33 * _tmp35 + _tmp24 * _tmp32 * _tmp35);
  ...
  const Scalar _tmp48 = _tmp38 * _tmp46 + _tmp40 * _tmp46 - _tmp43 * _tmp47;
  const Scalar _tmp49 = _tmp24 * _tmp36;
  ...
  const Scalar _tmp53 = Scalar(0.20999999999999999) * _tmp15 + Scalar(0.20999999999999999) * _tmp17;
  ...
  const Scalar _tmp57 = _tmp52 - _tmp54;
  ...
  const Scalar _tmp63 = (-_tmp43 + _tmp62) / (_tmp40 - _tmp61);
  ...
  const Scalar _tmp67 = _tmp66 + p_init1 + Scalar(8.3196563700000006);
  const Scalar _tmp68 = _tmp29 - _tmp30;
  ...
  const Scalar _tmp74 = _tmp49 * _tmp73 - _tmp72;
  const Scalar _tmp75 = _tmp50 * _tmp74;
  const Scalar _tmp76 = _tmp55 * _tmp73;
  const Scalar _tmp77 = -_tmp53 + _tmp57;
  const Scalar _tmp78 = -_tmp59 * _tmp75 -
                        _tmp63 * (-_tmp49 * _tmp76 - _tmp60 * _tmp75 + _tmp72 * _tmp77) -
                        _tmp73 * _tmp77 + _tmp76;
  const Scalar _tmp79 = Scalar(1.0) / (_tmp78);
  const Scalar _tmp80 = _tmp38 * _tmp73 - _tmp48 * _tmp75 + _tmp66 * _tmp73 - _tmp69 * _tmp72;
  const Scalar _tmp81 = _tmp79 * _tmp80;
  const Scalar _tmp82 = Scalar(1.0) / (_tmp80);
  const Scalar _tmp83 = _tmp78 * _tmp82;
  const Scalar _tmp84 = _tmp64 + _tmp83 * (-_tmp38 + _tmp48 * _tmp51 - _tmp64 * _tmp81);
  const Scalar _tmp85 = _tmp73 * _tmp79;
  const Scalar _tmp86 = _tmp74 * _tmp79;
  const Scalar _tmp87 = -_tmp49 - _tmp84 * _tmp86;
  const Scalar _tmp88 = _tmp46 * _tmp50;
  const Scalar _tmp89 = _tmp26 + _tmp68;
  const Scalar _tmp90 = _tmp89 + p_init0 + Scalar(-2.5202214700000001);
  const Scalar _tmp91 = _tmp22 + _tmp65;
  ...
  const Scalar _tmp97 = -_tmp59 * _tmp96 + _tmp60 * _tmp63 * _tmp96;
  const Scalar _tmp98 = _tmp83 * (-_tmp48 * _tmp96 - _tmp81 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp86 * _tmp98 + Scalar(1.0);
  const Scalar _tmp100 = _tmp92 * _tmp93;
  const Scalar _tmp101 = _tmp100 * fh1;
  const Scalar _tmp102 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp103 = _tmp61 * _tmp63 + _tmp62;
  const Scalar _tmp104 = 0;
  const Scalar _tmp105 = _tmp104 * _tmp75;
  const Scalar _tmp106 = _tmp37 * (_tmp104 * _tmp73 - _tmp105 * _tmp46);
  const Scalar _tmp107 = Scalar(1.0) * _tmp82;
  const Scalar _tmp108 = fh1 * (_tmp100 * _tmp89 - _tmp91 * _tmp94);
  ...
  _res(0, 0) = 0;
  _res(1, 0) = -_tmp106 *
               std::exp(_tmp101 * _tmp37 * (_tmp85 * _tmp98 + _tmp88 * _tmp99) + _tmp102 * _tmp106 +
                        _tmp108 * _tmp37 * (-_tmp107 * _tmp46 * _tmp75 + _tmp107 * _tmp73) +
                        _tmp37 * _tmp95 * (_tmp84 * _tmp85 + _tmp87 * _tmp88 + Scalar(1.0)));
  _res(2, 0) = -_tmp105 * std::exp(-_tmp101 * _tmp50 * _tmp99 + _tmp109 * _tmp75 +
                                   _tmp110 * _tmp75 - _tmp50 * _tmp87 * _tmp95);
  _res(3, 0) =
