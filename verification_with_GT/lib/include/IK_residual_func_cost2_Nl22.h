...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl22(
  ...
  const Scalar _tmp14 = -2 * std::pow(_tmp10, Scalar(2));
  const Scalar _tmp15 = 1 - 2 * std::pow(_tmp8, Scalar(2));
  const Scalar _tmp16 =
  ...
  const Scalar _tmp27 = _tmp17 * _tmp8;
  const Scalar _tmp28 = _tmp11 * _tmp7;
  ...
  const Scalar _tmp33 = Scalar(0.20999999999999999) * _tmp15 + Scalar(0.20999999999999999) * _tmp23;
  const Scalar _tmp34 = -_tmp33;
  const Scalar _tmp35 = _tmp18 + _tmp19;
  const Scalar _tmp36 = -Scalar(0.010999999999999999) * _tmp35;
  const Scalar _tmp37 = Scalar(0.20999999999999999) * _tmp27 - Scalar(0.20999999999999999) * _tmp28;
  ...
  const Scalar _tmp83 = Scalar(1.0) / (_tmp53 * _tmp79 - _tmp82);
  const Scalar _tmp84 = _tmp65 * _tmp83;
  const Scalar _tmp85 = -_tmp53 * _tmp80 + _tmp71 * _tmp82;
  const Scalar _tmp86 = -_tmp53 * _tmp70 + _tmp64 * _tmp68 - _tmp84 * _tmp85;
  ...
  const Scalar _tmp93 = -_tmp63 * _tmp68 + _tmp70 - _tmp81 * _tmp84 - _tmp86 * _tmp92;
  const Scalar _tmp94 = Scalar(1.0) / (_tmp93);
  const Scalar _tmp95 = Scalar(1.0) * _tmp89;
  const Scalar _tmp96 = Scalar(1.0) * _tmp83;
  const Scalar _tmp97 = -_tmp81 * _tmp96 + _tmp83 * _tmp85 * _tmp91 * _tmp95;
  const Scalar _tmp98 =
      std::sqrt(Scalar(std::pow(_tmp47, Scalar(2)) + std::pow(_tmp52, Scalar(2))));
  const Scalar _tmp99 = Scalar(1.0) / (_tmp98);
  const Scalar _tmp100 = _tmp48 * _tmp98;
  const Scalar _tmp101 = _tmp100 * (_tmp45 * _tmp52 * _tmp99 - _tmp47 * _tmp50 * _tmp99);
  const Scalar _tmp102 = _tmp101 * _tmp79 + _tmp72 * _tmp79 - _tmp75 * _tmp82;
  const Scalar _tmp103 = _tmp101 * _tmp63 - _tmp102 * _tmp84 - _tmp55 * _tmp64 + _tmp59 * _tmp63;
  ...
  const Scalar _tmp110 = _tmp79 * _tmp83;
  const Scalar _tmp111 = _tmp32 + Scalar(-4.8333311099999996);
  ...
  const Scalar _tmp117 = _tmp105 * _tmp65 * _tmp96;
  const Scalar _tmp118 = _tmp112 * _tmp113;
  const Scalar _tmp119 = fh1 * (_tmp114 * _tmp39 - _tmp118 * _tmp31);
  const Scalar _tmp120 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp121 = _tmp87 * _tmp92 + _tmp90;
  const Scalar _tmp122 = 0;
  const Scalar _tmp123 = _tmp53 * _tmp83;
  const Scalar _tmp124 = _tmp123 * _tmp85 + _tmp53 * _tmp69;
  const Scalar _tmp125 = _tmp123 * _tmp81 - _tmp124 * _tmp92 - _tmp69;
  const Scalar _tmp126 = _tmp106 * (-_tmp101 + _tmp102 * _tmp123 - _tmp104 * _tmp125);
  const Scalar _tmp127 = _tmp94 * (_tmp125 + _tmp126);
  const Scalar _tmp128 = -_tmp127 * _tmp65 - _tmp53;
  const Scalar _tmp129 = _tmp118 * fh1;
  const Scalar _tmp130 = -_tmp100 * _tmp115 * (_tmp108 * _tmp63 + _tmp109 * _tmp110) -
                         _tmp100 * _tmp119 * (_tmp116 * _tmp63 - _tmp117 * _tmp79) -
                         _tmp100 * _tmp120 * (_tmp122 * _tmp63 - _tmp122 * _tmp79 * _tmp84) -
                         _tmp100 * _tmp129 * (_tmp110 * _tmp128 + _tmp127 * _tmp63 + Scalar(1.0));
  const Scalar _tmp131 = Scalar(1.0) / (_tmp130);
  const Scalar _tmp132 = _tmp59 + _tmp88;
  const Scalar _tmp133 = _tmp132 * _tmp92;
  const Scalar _tmp134 = Scalar(1.0) / (-_tmp133 - _tmp55 + _tmp90);
  const Scalar _tmp135 = Scalar(1.0) * _tmp134;
  const Scalar _tmp136 = _tmp121 * _tmp134;
  const Scalar _tmp137 = -_tmp122 * _tmp86 - _tmp132 * _tmp136 + _tmp88;
  const Scalar _tmp138 = _tmp132 * _tmp134;
  const Scalar _tmp139 = _tmp107 * _tmp138 - _tmp108 * _tmp86 - _tmp85 * _tmp96;
  const Scalar _tmp140 = _tmp22 * fh1;
  const Scalar _tmp141 = -_tmp114 * _tmp140 - Scalar(3.29616) * _tmp25 - _tmp31 * fv1;
  const Scalar _tmp142 = _tmp133 * _tmp135 + Scalar(1.0);
  const Scalar _tmp143 = _tmp135 * _tmp92;
  const Scalar _tmp144 = _tmp106 * _tmp135;
  const Scalar _tmp145 = -_tmp116 * _tmp86 + _tmp132 * _tmp144;
  const Scalar _tmp146 = _tmp124 + _tmp126 * _tmp138 - _tmp127 * _tmp86;
  const Scalar _tmp147 = _tmp132 * _tmp89;
  const Scalar _tmp148 = _tmp118 * _tmp140 + Scalar(3.29616) * _tmp35 + _tmp39 * fv1;
  const Scalar _tmp149 = std::asinh(
      _tmp131 * (Scalar(1.0) * _tmp115 * (_tmp107 * _tmp135 - _tmp139 * _tmp95) +
                 Scalar(1.0) * _tmp119 * (_tmp144 - _tmp145 * _tmp95) +
                 Scalar(1.0) * _tmp120 * (-_tmp121 * _tmp135 - _tmp137 * _tmp95 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp129 * (_tmp126 * _tmp135 - _tmp146 * _tmp95) +
                 Scalar(1.0) * _tmp141 * (-_tmp142 * _tmp95 + _tmp143) +
                 Scalar(1.0) * _tmp148 * (_tmp135 * _tmp147 - _tmp135)));
  const Scalar _tmp150 = Scalar(9.6622558468725703) * _tmp130;
  const Scalar _tmp151 = Scalar(7.3875128562042027) *
  ...
  const Scalar _tmp152 =
      Scalar(69.216682114881593) *
          std::pow(Scalar(-Scalar(0.12019727204189803) * _tmp73 - 1), Scalar(2)) +
      Scalar(3.9500536956656402) *
          std::pow(Scalar(-Scalar(0.50315118556004401) * _tmp76 - 1), Scalar(2));
  const Scalar _tmp153 = _tmp120 * _tmp122;
  const Scalar _tmp154 = _tmp109 * _tmp115 * _tmp83 - _tmp117 * _tmp119 +
                         _tmp128 * _tmp129 * _tmp83 - _tmp153 * _tmp84;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 = _tmp135 * _tmp148;
  const Scalar _tmp157 =
      std::asinh(_tmp155 * (_tmp115 * _tmp139 * _tmp89 + _tmp119 * _tmp145 * _tmp89 +
                            _tmp120 * _tmp137 * _tmp89 + _tmp129 * _tmp146 * _tmp89 +
                            _tmp141 * _tmp142 * _tmp89 - _tmp147 * _tmp156));
  const Scalar _tmp158 = Scalar(9.6622558468725703) * _tmp154;
  const Scalar _tmp159 = _tmp108 * _tmp115 + _tmp116 * _tmp119 + _tmp127 * _tmp129 + _tmp153;
  const Scalar _tmp160 = Scalar(1.0) / (_tmp159);
  const Scalar _tmp161 = Scalar(6.351516257848961) *
  ...
  const Scalar _tmp162 =
      std::asinh(_tmp160 * (-_tmp107 * _tmp115 * _tmp134 - _tmp119 * _tmp144 + _tmp120 * _tmp136 -
                            _tmp126 * _tmp129 * _tmp134 - _tmp141 * _tmp143 + _tmp156));
  ...
  _res(1, 0) =
      _tmp150 *
          (-std::sinh(Scalar(1.0) * _tmp149) -
           std::sinh(Scalar(0.1034955) * _tmp131 * (-_tmp149 * _tmp150 - std::sqrt(_tmp151)))) -
      Scalar(8.36416322) *
          std::sqrt(Scalar(Scalar(0.014294040284261563) * _tmp151 +
  ...
  _res(3, 0) =
      _tmp163 *
          (-std::sinh(Scalar(1.0) * _tmp162) -
           std::sinh(Scalar(0.1034955) * _tmp160 * (-std::sqrt(_tmp161) - _tmp162 * _tmp163))) -
      Scalar(8.4693136199999994) *
          std::sqrt(Scalar(Scalar(0.013941309530580858) * _tmp161 +
                           std::pow(Scalar(-Scalar(0.11807332268798426) * _tmp68 -
