...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl20(
  ...
  const Scalar _tmp30 = _tmp14 * _tmp9;
  const Scalar _tmp31 = 2 * _tmp12 * _tmp8;
  const Scalar _tmp32 =
      -Scalar(0.010999999999999999) * _tmp30 - Scalar(0.010999999999999999) * _tmp31;
  const Scalar _tmp33 = Scalar(0.20999999999999999) * _tmp11 - Scalar(0.20999999999999999) * _tmp15;
  ...
  const Scalar _tmp39 = _tmp28 + _tmp34;
  ...
  const Scalar _tmp45 = _tmp26 * _tmp37;
  const Scalar _tmp46 = Scalar(1.0) / (_tmp38 * _tmp44 - _tmp45);
  const Scalar _tmp47 = _tmp20 + _tmp23;
  const Scalar _tmp48 = _tmp16 + _tmp47;
  const Scalar _tmp49 = _tmp48 + p_init1 + Scalar(-4.7752063900000001);
  ...
  const Scalar _tmp58 = Scalar(0.20999999999999999) * _tmp30 - Scalar(0.20999999999999999) * _tmp31;
  const Scalar _tmp59 =
      -Scalar(0.010999999999999999) * _tmp18 - Scalar(0.010999999999999999) * _tmp27;
  ...
  const Scalar _tmp65 = _tmp46 * (-_tmp38 * _tmp62 + _tmp64);
  const Scalar _tmp66 = _tmp58 + _tmp59 + _tmp60;
  const Scalar _tmp67 = _tmp44 * _tmp63;
  const Scalar _tmp68 = -_tmp44 * _tmp64 + _tmp45 * _tmp62;
  const Scalar _tmp69 = Scalar(1.0) * _tmp39;
  const Scalar _tmp70 = Scalar(1.0) * _tmp42;
  const Scalar _tmp71 = (-_tmp35 + _tmp69) / (_tmp25 - _tmp70);
  const Scalar _tmp72 = _tmp54 * _tmp63 - _tmp54 * _tmp66 - _tmp56 * _tmp65 -
                        _tmp71 * (-_tmp54 * _tmp67 + _tmp55 * _tmp66 - _tmp57 * _tmp68);
  ...
  const Scalar _tmp79 = _tmp78 * (-_tmp38 * _tmp76 + _tmp54 * _tmp75);
  const Scalar _tmp80 = Scalar(1.0) / (_tmp77);
  const Scalar _tmp81 = _tmp78 * (_tmp39 * _tmp43 * _tmp80 - _tmp40 * _tmp42 * _tmp80);
  const Scalar _tmp82 = _tmp46 * _tmp68;
  const Scalar _tmp83 = _tmp44 * _tmp65 - _tmp63 - _tmp71 * (_tmp44 * _tmp82 + _tmp67);
  const Scalar _tmp84 = _tmp25 * _tmp38 - _tmp35 * _tmp45 + _tmp38 * _tmp81;
  const Scalar _tmp85 = _tmp48 * _tmp54 - _tmp51 * _tmp55 + _tmp54 * _tmp81 - _tmp57 * _tmp84;
  const Scalar _tmp86 = _tmp73 * _tmp85;
  const Scalar _tmp87 = _tmp46 * _tmp84;
  const Scalar _tmp88 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp89 = _tmp72 * _tmp88;
  const Scalar _tmp90 = _tmp83 + _tmp89 * (_tmp44 * _tmp87 - _tmp81 - _tmp83 * _tmp86);
  const Scalar _tmp91 = _tmp56 * _tmp73;
  const Scalar _tmp92 = -_tmp44 - _tmp90 * _tmp91;
  const Scalar _tmp93 = _tmp38 * _tmp46;
  const Scalar _tmp94 = _tmp54 * _tmp73;
  const Scalar _tmp95 = _tmp17 + _tmp47;
  const Scalar _tmp96 = _tmp95 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp97 = _tmp29 + _tmp50;
  const Scalar _tmp98 = _tmp97 + p_init0 + Scalar(1.79662371);
  const Scalar _tmp99 = std::pow(Scalar(std::pow(_tmp96, Scalar(2)) + std::pow(_tmp98, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp100 = _tmp98 * _tmp99;
  const Scalar _tmp101 = _tmp78 * fh1;
  const Scalar _tmp102 = Scalar(1.0) * _tmp88;
  const Scalar _tmp103 = _tmp96 * _tmp99;
  const Scalar _tmp104 = fh1 * (-_tmp100 * _tmp95 + _tmp103 * _tmp97);
  const Scalar _tmp105 = -Scalar(1.0) * _tmp65 + Scalar(1.0) * _tmp71 * _tmp82;
  const Scalar _tmp106 = _tmp105 + _tmp89 * (-_tmp105 * _tmp86 - Scalar(1.0) * _tmp87);
  const Scalar _tmp107 = -_tmp106 * _tmp91 + Scalar(1.0);
  const Scalar _tmp108 = _tmp0 * _tmp75;
  const Scalar _tmp109 = _tmp102 * _tmp104;
  const Scalar _tmp110 = _tmp46 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp79 * std::exp(_tmp0 * _tmp79 +
                         _tmp100 * _tmp101 * (_tmp90 * _tmp94 + _tmp92 * _tmp93 + Scalar(1.0)) +
                         _tmp101 * _tmp103 * (_tmp106 * _tmp94 + _tmp107 * _tmp93) +
                         _tmp104 * _tmp78 * (-_tmp102 * _tmp38 * _tmp57 + _tmp102 * _tmp54));
  _res(2, 0) = -_tmp76 * std::exp(-_tmp100 * _tmp110 * _tmp92 - _tmp103 * _tmp107 * _tmp110 +
                                  _tmp108 * _tmp57 + _tmp109 * _tmp57);
  _res(3, 0) = _tmp75 * std::exp(-_tmp100 * _tmp111 * _tmp90 - _tmp103 * _tmp106 * _tmp111 -
                                 _tmp108 - _tmp109);
