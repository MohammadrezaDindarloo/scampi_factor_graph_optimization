...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl12(
  ...
  const Scalar _tmp46 = _tmp32 * _tmp33;
  const Scalar _tmp47 = -_tmp22 * _tmp46 + _tmp31 * _tmp34 + _tmp34 * _tmp45;
  ...
  const Scalar _tmp59 = -_tmp34 * _tmp55 + _tmp58;
  const Scalar _tmp60 = _tmp46 * _tmp55 - _tmp48 * _tmp58;
  const Scalar _tmp61 = Scalar(1.0) * _tmp39;
  const Scalar _tmp62 = Scalar(1.0) * _tmp36;
  const Scalar _tmp63 = (-_tmp22 + _tmp62) / (_tmp31 - _tmp61);
  const Scalar _tmp64 = -_tmp50 * _tmp59 + _tmp50 * _tmp60 * _tmp63;
  const Scalar _tmp65 = _tmp26 + _tmp29;
  const Scalar _tmp66 = _tmp38 + _tmp65;
  const Scalar _tmp67 = _tmp66 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp68 = _tmp16 + _tmp20;
  ...
  const Scalar _tmp95 = _tmp44 * fh1;
  const Scalar _tmp96 = Scalar(1.0) * _tmp82;
  const Scalar _tmp97 = _tmp34 * _tmp77;
  ...
  const Scalar _tmp101 = _tmp61 * _tmp63 + _tmp62;
  const Scalar _tmp102 = 0;
  const Scalar _tmp103 = _tmp48 * _tmp49;
  const Scalar _tmp104 = _tmp103 * _tmp59 - _tmp57 - _tmp63 * (_tmp103 * _tmp60 + _tmp48 * _tmp57);
  const Scalar _tmp105 = _tmp104 + _tmp83 * (_tmp103 * _tmp47 - _tmp104 * _tmp81 - _tmp45);
  const Scalar _tmp106 = -_tmp105 * _tmp86 - _tmp48;
  const Scalar _tmp107 = _tmp100 * _tmp102;
  const Scalar _tmp108 = _tmp49 * fh1;
  const Scalar _tmp109 = _tmp96 * _tmp99;
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp44 * (_tmp102 * _tmp72 - _tmp102 * _tmp97) +
                        _tmp44 * _tmp99 * (_tmp72 * _tmp96 - _tmp96 * _tmp97) +
                        _tmp94 * _tmp95 * (_tmp84 * _tmp85 + _tmp87 * _tmp88) +
                        _tmp95 * _tmp98 * (_tmp105 * _tmp85 + _tmp106 * _tmp88 + Scalar(1.0)));
  _res(2, 0) = std::exp(-_tmp106 * _tmp108 * _tmp98 + _tmp107 * _tmp77 - _tmp108 * _tmp87 * _tmp94 +
                        _tmp109 * _tmp77);
  _res(3, 0) =
      std::exp(-_tmp105 * _tmp110 * _tmp98 - _tmp107 - _tmp109 - _tmp110 * _tmp84 * _tmp94);
