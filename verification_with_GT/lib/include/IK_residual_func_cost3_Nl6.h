...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl6(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp30 = Scalar(0.20999999999999999) * _tmp15 +
                        Scalar(0.20999999999999999) * _tmp29 + Scalar(0.20999999999999999);
  const Scalar _tmp31 = _tmp18 * _tmp7;
  const Scalar _tmp32 = _tmp11 * _tmp8;
  const Scalar _tmp33 =
  ...
  const Scalar _tmp39 = (_tmp24 - _tmp26) / (-_tmp36 + _tmp38);
  const Scalar _tmp40 = _tmp35 + p_init1 + Scalar(8.3196563700000006);
  const Scalar _tmp41 = _tmp23 + p_init0 + Scalar(1.9874742000000001);
  const Scalar _tmp42 = Scalar(1.0) / (_tmp41);
  const Scalar _tmp43 = _tmp40 * _tmp42;
  const Scalar _tmp44 = _tmp38 + p_init1 + Scalar(-4.7752063900000001);
  ...
  const Scalar _tmp49 = Scalar(1.0) / (_tmp43 * _tmp47 - _tmp48);
  ...
  const Scalar _tmp56 = _tmp50 + _tmp51 + _tmp52;
  const Scalar _tmp57 = -_tmp47 * _tmp55 + _tmp48 * _tmp56;
  const Scalar _tmp58 = _tmp49 * _tmp57;
  const Scalar _tmp59 = _tmp49 * (_tmp47 * _tmp54 - _tmp47 * _tmp56);
  const Scalar _tmp60 = Scalar(1.0) * _tmp39 * _tmp58 - Scalar(1.0) * _tmp59;
  const Scalar _tmp61 = _tmp28 + _tmp37;
  const Scalar _tmp62 = _tmp61 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp63 = _tmp13 + _tmp22;
  ...
  const Scalar _tmp68 = _tmp50 + _tmp53;
  const Scalar _tmp69 = _tmp62 * _tmp65;
  const Scalar _tmp70 = _tmp43 * _tmp66 - _tmp69;
  const Scalar _tmp71 = _tmp49 * _tmp70;
  const Scalar _tmp72 = -_tmp39 * (-_tmp43 * _tmp67 - _tmp57 * _tmp71 + _tmp68 * _tmp69) -
                        _tmp59 * _tmp70 - _tmp66 * _tmp68 + _tmp67;
  ...
  const Scalar _tmp77 = _tmp76 * (_tmp23 * _tmp40 * _tmp75 - _tmp35 * _tmp41 * _tmp75);
  const Scalar _tmp78 = -_tmp26 * _tmp48 + _tmp38 * _tmp47 + _tmp47 * _tmp77;
  const Scalar _tmp79 = _tmp61 * _tmp66 - _tmp63 * _tmp69 + _tmp66 * _tmp77 - _tmp71 * _tmp78;
  const Scalar _tmp80 = _tmp73 * _tmp79;
  const Scalar _tmp81 = _tmp49 * _tmp78;
  const Scalar _tmp82 = Scalar(1.0) / (_tmp79);
  const Scalar _tmp83 = _tmp72 * _tmp82;
  const Scalar _tmp84 = _tmp60 + _tmp83 * (-_tmp60 * _tmp80 - Scalar(1.0) * _tmp81);
  const Scalar _tmp85 = _tmp66 * _tmp73;
  const Scalar _tmp86 = _tmp70 * _tmp73;
  const Scalar _tmp87 = -_tmp84 * _tmp86 + Scalar(1.0);
  const Scalar _tmp88 = _tmp47 * _tmp49;
  const Scalar _tmp89 = _tmp14 + _tmp25;
  const Scalar _tmp90 = _tmp89 + p_init0 + Scalar(-2.5202214700000001);
  const Scalar _tmp91 = _tmp27 + _tmp34;
  ...
  const Scalar _tmp96 = -_tmp39 * (_tmp43 * _tmp58 + _tmp55) + _tmp43 * _tmp59 - _tmp54;
  const Scalar _tmp97 = _tmp83 * (_tmp43 * _tmp81 - _tmp77 - _tmp80 * _tmp96) + _tmp96;
  const Scalar _tmp98 = -_tmp43 - _tmp86 * _tmp97;
  const Scalar _tmp99 = _tmp90 * _tmp93;
  const Scalar _tmp100 = _tmp99 * fh1;
  const Scalar _tmp101 = Scalar(1.0) * _tmp82;
  const Scalar _tmp102 = fh1 * (_tmp89 * _tmp94 - _tmp91 * _tmp99);
  const Scalar _tmp103 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp104 = _tmp24 + _tmp36 * _tmp39;
  const Scalar _tmp105 = 0;
  const Scalar _tmp106 = _tmp105 * _tmp73;
  const Scalar _tmp107 = _tmp105 * _tmp86;
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp76 * (_tmp85 * _tmp97 + _tmp88 * _tmp98 + Scalar(1.0)) +
                        _tmp102 * _tmp76 * (-_tmp101 * _tmp47 * _tmp71 + _tmp101 * _tmp66) +
                        _tmp103 * _tmp76 * (_tmp106 * _tmp66 - _tmp107 * _tmp88) +
                        _tmp76 * _tmp95 * (_tmp84 * _tmp85 + _tmp87 * _tmp88));
  _res(2, 0) = std::exp(-_tmp100 * _tmp49 * _tmp98 + _tmp103 * _tmp107 * _tmp49 + _tmp108 * _tmp71 -
                        _tmp49 * _tmp87 * _tmp95);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp73 * _tmp97 - _tmp103 * _tmp106 - _tmp108 - _tmp73 * _tmp84 * _tmp95);
