...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl2(
  ...
  const Scalar _tmp24 = _tmp23 + p_init0 + Scalar(-2.71799795);
  ...
  const Scalar _tmp27 = _tmp15 * _tmp8;
  ...
  const Scalar _tmp38 = _tmp37 + p_init0 + Scalar(-2.5202214700000001);
  const Scalar _tmp39 = _tmp29 - _tmp31;
  ...
  const Scalar _tmp48 = Scalar(1.0) * _tmp23;
  const Scalar _tmp49 = (-_tmp37 + _tmp48) / (_tmp40 - _tmp47);
  ...
  const Scalar _tmp55 = _tmp18 - _tmp21;
  ...
  const Scalar _tmp61 = _tmp35 * _tmp59 - _tmp60;
  const Scalar _tmp62 = Scalar(0.20999999999999999) * _tmp27 + Scalar(0.20999999999999999) * _tmp28;
  const Scalar _tmp63 =
      -Scalar(0.010999999999999999) * _tmp20 - Scalar(0.010999999999999999) * _tmp30;
  const Scalar _tmp64 = Scalar(0.20999999999999999) * _tmp16 - Scalar(0.20999999999999999) * _tmp17;
  ...
  const Scalar _tmp69 = _tmp45 * (-_tmp35 * _tmp68 + _tmp44 * _tmp66);
  const Scalar _tmp70 = _tmp62 + _tmp63 - _tmp64;
  const Scalar _tmp71 = _tmp59 * _tmp67;
  const Scalar _tmp72 = _tmp45 * (-_tmp43 * _tmp66 + _tmp68);
  const Scalar _tmp73 = -_tmp49 * (-_tmp35 * _tmp71 + _tmp60 * _tmp70 - _tmp61 * _tmp69) -
                        _tmp59 * _tmp70 - _tmp61 * _tmp72 + _tmp71;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp75 = _tmp61 * _tmp74;
  const Scalar _tmp76 = _tmp51 * _tmp75;
  ...
  const Scalar _tmp80 = _tmp79 * (-_tmp46 * _tmp76 + _tmp59 * _tmp77);
  const Scalar _tmp81 = Scalar(1.0) / (_tmp78);
  const Scalar _tmp82 = _tmp79 * (_tmp23 * _tmp34 * _tmp81 - _tmp24 * _tmp33 * _tmp81);
  const Scalar _tmp83 = _tmp45 * (-_tmp37 * _tmp44 + _tmp40 * _tmp43 + _tmp43 * _tmp82);
  const Scalar _tmp84 = _tmp35 * _tmp72 - _tmp49 * (_tmp35 * _tmp67 + _tmp35 * _tmp69) - _tmp67;
  const Scalar _tmp85 = _tmp53 * _tmp59 - _tmp56 * _tmp60 + _tmp59 * _tmp82 - _tmp61 * _tmp83;
  const Scalar _tmp86 = _tmp74 * _tmp85;
  const Scalar _tmp87 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp88 = _tmp73 * _tmp87;
  const Scalar _tmp89 = _tmp84 + _tmp88 * (_tmp35 * _tmp83 - _tmp82 - _tmp84 * _tmp86);
  const Scalar _tmp90 = -_tmp35 - _tmp75 * _tmp89;
  const Scalar _tmp91 = _tmp59 * _tmp74;
  const Scalar _tmp92 = _tmp39 + _tmp52;
  const Scalar _tmp93 = _tmp92 + p_init1 + Scalar(8.3196563700000006);
  const Scalar _tmp94 = _tmp36 + _tmp55;
  ...
  const Scalar _tmp98 = _tmp79 * fh1;
  ...
  const Scalar _tmp102 = Scalar(1.0) * _tmp49 * _tmp69 - Scalar(1.0) * _tmp72;
  const Scalar _tmp103 = _tmp102 + _tmp88 * (-_tmp102 * _tmp86 - Scalar(1.0) * _tmp83);
  const Scalar _tmp104 = -_tmp103 * _tmp75 + Scalar(1.0);
  const Scalar _tmp105 = _tmp45 * fh1;
  const Scalar _tmp106 = _tmp101 * _tmp99;
  const Scalar _tmp107 = _tmp45 * _tmp76;
  const Scalar _tmp108 = _tmp74 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp80 * std::exp(_tmp0 * _tmp80 + _tmp100 * _tmp98 * (_tmp103 * _tmp91 + _tmp104 * _tmp46) +
                         _tmp101 * _tmp79 * (-_tmp46 * _tmp61 * _tmp99 + _tmp59 * _tmp99) +
                         _tmp97 * _tmp98 * (_tmp46 * _tmp90 + _tmp89 * _tmp91 + Scalar(1.0)));
  _res(2, 0) = -_tmp107 * std::exp(_tmp0 * _tmp107 - _tmp100 * _tmp104 * _tmp105 -
                                   _tmp105 * _tmp90 * _tmp97 + _tmp106 * _tmp45 * _tmp61);
  _res(3, 0) = _tmp77 * std::exp(-_tmp0 * _tmp77 - _tmp100 * _tmp103 * _tmp108 - _tmp106 -
