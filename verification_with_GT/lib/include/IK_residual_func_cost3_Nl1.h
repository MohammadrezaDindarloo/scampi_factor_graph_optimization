 ...
 *
 * Symbolic function: IK_residual_func_cost3_Nl1
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl1(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp25 = Scalar(0.20999999999999999) * _tmp18 + Scalar(0.20999999999999999) * _tmp19;
  const Scalar _tmp26 = _tmp13 * _tmp7;
  const Scalar _tmp27 = _tmp12 * _tmp15;
  const Scalar _tmp28 =
  ...
  const Scalar _tmp36 = -Scalar(0.010999999999999999) * _tmp29 -
                        Scalar(0.010999999999999999) * _tmp8 + Scalar(-0.010999999999999999);
  const Scalar _tmp37 = Scalar(0.20999999999999999) * _tmp14 - Scalar(0.20999999999999999) * _tmp16;
  const Scalar _tmp38 = _tmp36 + _tmp37;
  const Scalar _tmp39 = -_tmp35 + _tmp38;
  const Scalar _tmp40 = -_tmp25;
  const Scalar _tmp41 = _tmp28 + _tmp30;
  const Scalar _tmp42 = _tmp40 + _tmp41;
  const Scalar _tmp43 = _tmp42 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp44 = -_tmp11;
  const Scalar _tmp45 = _tmp17 + _tmp20;
  ...
  const Scalar _tmp53 = -_tmp34 * _tmp50 + _tmp51 * _tmp52;
  const Scalar _tmp54 = Scalar(1.0) * _tmp32;
  const Scalar _tmp55 = Scalar(1.0) * _tmp22;
  const Scalar _tmp56 = (-_tmp46 + _tmp55) / (_tmp42 - _tmp54);
  const Scalar _tmp57 = Scalar(1.0) / (_tmp34 * _tmp49 - _tmp52);
  const Scalar _tmp58 = Scalar(1.0) * _tmp57;
  const Scalar _tmp59 = -_tmp49 * _tmp51 + _tmp50;
  ...
  const Scalar _tmp68 = _tmp34 * _tmp66 - _tmp67;
  const Scalar _tmp69 = _tmp57 * _tmp68;
  const Scalar _tmp70 = _tmp35 + _tmp38;
  const Scalar _tmp71 = _tmp34 * _tmp39;
  const Scalar _tmp72 = _tmp39 * _tmp66 -
                        _tmp56 * (-_tmp53 * _tmp69 - _tmp66 * _tmp71 + _tmp67 * _tmp70) -
                        _tmp59 * _tmp69 - _tmp66 * _tmp70;
  ...
  const Scalar _tmp78 = _tmp42 * _tmp49 - _tmp46 * _tmp52 + _tmp49 * _tmp77;
  const Scalar _tmp79 = _tmp61 * _tmp66 - _tmp63 * _tmp67 + _tmp66 * _tmp77 - _tmp69 * _tmp78;
  const Scalar _tmp80 = _tmp73 * _tmp79;
  const Scalar _tmp81 = Scalar(1.0) / (_tmp79);
  const Scalar _tmp82 = _tmp72 * _tmp81;
  const Scalar _tmp83 = _tmp60 + _tmp82 * (-_tmp58 * _tmp78 - _tmp60 * _tmp80);
  const Scalar _tmp84 = _tmp68 * _tmp73;
  const Scalar _tmp85 = -_tmp83 * _tmp84 + Scalar(1.0);
  const Scalar _tmp86 = _tmp49 * _tmp57;
  const Scalar _tmp87 = _tmp66 * _tmp73;
  const Scalar _tmp88 = _tmp31 + _tmp40;
  const Scalar _tmp89 = _tmp88 + p_init1 + Scalar(8.3196563700000006);
  const Scalar _tmp90 = _tmp21 + _tmp44;
  ...
  const Scalar _tmp96 = _tmp58 * _tmp68 * _tmp81;
  const Scalar _tmp97 = _tmp91 * _tmp92;
  const Scalar _tmp98 = fh1 * (-_tmp88 * _tmp97 + _tmp90 * _tmp93);
  const Scalar _tmp99 = _tmp34 * _tmp57;
  const Scalar _tmp100 = -_tmp39 - _tmp56 * (_tmp53 * _tmp99 + _tmp71) + _tmp59 * _tmp99;
  const Scalar _tmp101 = _tmp100 + _tmp82 * (-_tmp100 * _tmp80 - _tmp77 + _tmp78 * _tmp99);
  const Scalar _tmp102 = -_tmp101 * _tmp84 - _tmp34;
  const Scalar _tmp103 = _tmp97 * fh1;
  const Scalar _tmp104 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp105 = _tmp54 * _tmp56 + _tmp55;
  ...
  _res(1, 0) = std::exp(_tmp103 * _tmp76 * (_tmp101 * _tmp87 + _tmp102 * _tmp86 + Scalar(1.0)) +
                        _tmp104 * _tmp76 * (-_tmp106 * _tmp49 * _tmp69 + _tmp106 * _tmp66) +
                        _tmp76 * _tmp94 * (_tmp83 * _tmp87 + _tmp85 * _tmp86) +
                        _tmp76 * _tmp98 * (-_tmp49 * _tmp96 + _tmp66 * _tmp95));
  _res(2, 0) = std::exp(-_tmp102 * _tmp103 * _tmp57 + _tmp107 * _tmp69 - _tmp57 * _tmp85 * _tmp94 +
                        _tmp96 * _tmp98);
  _res(3, 0) =
      std::exp(-_tmp101 * _tmp103 * _tmp73 - _tmp107 - _tmp73 * _tmp83 * _tmp94 - _tmp95 * _tmp98);
