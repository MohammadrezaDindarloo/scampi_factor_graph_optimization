...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl6(
  ...
  const Scalar _tmp25 = _tmp18 + _tmp21;
  ...
  const Scalar _tmp57 = -_tmp43 * _tmp55 + _tmp48 * _tmp56;
  const Scalar _tmp58 = _tmp49 * _tmp57;
  const Scalar _tmp59 = _tmp49 * (-_tmp47 * _tmp56 + _tmp55);
  ...
  const Scalar _tmp63 = _tmp14 + _tmp22;
  ...
  const Scalar _tmp89 = _tmp15 + _tmp25;
  ...
  const Scalar _tmp95 = _tmp76 * fh1;
  const Scalar _tmp96 = -_tmp39 * (_tmp43 * _tmp54 + _tmp43 * _tmp58) + _tmp43 * _tmp59 - _tmp54;
  ...
  const Scalar _tmp101 = fh1 * (_tmp89 * _tmp94 - _tmp91 * _tmp99);
  const Scalar _tmp102 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp103 = _tmp24 + _tmp36 * _tmp39;
  const Scalar _tmp104 = 0;
  const Scalar _tmp105 = _tmp104 * _tmp73;
  const Scalar _tmp106 = _tmp104 * _tmp86;
  const Scalar _tmp107 = _tmp76 * (_tmp105 * _tmp66 - _tmp106 * _tmp88);
  const Scalar _tmp108 = _tmp49 * fh1;
  const Scalar _tmp109 = _tmp106 * _tmp49;
  ...
  _res(0, 0) = 0;
  _res(1, 0) = -_tmp107 *
               std::exp(_tmp101 * _tmp76 * (-_tmp100 * _tmp47 * _tmp71 + _tmp100 * _tmp66) +
                        _tmp102 * _tmp107 + _tmp94 * _tmp95 * (_tmp84 * _tmp85 + _tmp87 * _tmp88) +
                        _tmp95 * _tmp99 * (_tmp85 * _tmp97 + _tmp88 * _tmp98 + Scalar(1.0)));
  _res(2, 0) = -_tmp109 * std::exp(_tmp102 * _tmp109 - _tmp108 * _tmp87 * _tmp94 -
                                   _tmp108 * _tmp98 * _tmp99 + _tmp110 * _tmp71);
  _res(3, 0) = _tmp105 * std::exp(-_tmp102 * _tmp105 - _tmp110 - _tmp111 * _tmp84 * _tmp94 -
                                  _tmp111 * _tmp97 * _tmp99);
