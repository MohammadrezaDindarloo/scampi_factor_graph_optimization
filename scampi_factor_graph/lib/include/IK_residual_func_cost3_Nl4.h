...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl4(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp11 = _tmp3 * rot_init_x;
  const Scalar _tmp12 = _tmp11 * ry + _tmp2 * rot_init_z - _tmp5 * rot_init_y + _tmp6 * rot_init_w;
  const Scalar _tmp13 =
      -2 * _tmp11 * rx + 2 * _tmp2 * rot_init_w - 2 * _tmp4 * rot_init_y - 2 * _tmp6 * rot_init_z;
  const Scalar _tmp14 = _tmp12 * _tmp13;
  const Scalar _tmp15 = Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp14;
  const Scalar _tmp16 = 2 * _tmp12 * _tmp7;
  ...
  const Scalar _tmp28 = _tmp13 * _tmp7;
  const Scalar _tmp29 =
      -Scalar(0.010999999999999999) * _tmp27 - Scalar(0.010999999999999999) * _tmp28;
  const Scalar _tmp30 = Scalar(0.20999999999999999) * _tmp10 - Scalar(0.20999999999999999) * _tmp14;
  ...
  const Scalar _tmp36 = _tmp24 * _tmp34;
  const Scalar _tmp37 = _tmp29 - _tmp30;
  const Scalar _tmp38 = _tmp26 + _tmp37;
  const Scalar _tmp39 = _tmp38 + p_init0 + Scalar(-2.5202214700000001);
  ...
  const Scalar _tmp55 = _tmp54 * (-_tmp46 * _tmp50 * _tmp52 + _tmp47 * _tmp49 * _tmp52);
  const Scalar _tmp56 = _tmp42 * _tmp43;
  const Scalar _tmp57 = -_tmp38 * _tmp56 + _tmp41 * _tmp44 + _tmp44 * _tmp55;
  const Scalar _tmp58 = _tmp47 * _tmp53;
  const Scalar _tmp59 = Scalar(1.0) / (_tmp44 * _tmp58 - _tmp56);
  const Scalar _tmp60 = _tmp35 * _tmp58 - _tmp36;
  const Scalar _tmp61 = _tmp59 * _tmp60;
  const Scalar _tmp62 = _tmp23 * _tmp35 - _tmp32 * _tmp36 + _tmp35 * _tmp55 - _tmp57 * _tmp61;
  ...
  const Scalar _tmp67 = _tmp40 + _tmp45;
  const Scalar _tmp68 = _tmp67 + p_init1 + Scalar(8.3196563700000006);
  const Scalar _tmp69 = _tmp37 + _tmp48;
  const Scalar _tmp70 = _tmp69 + p_init0 + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp74 = fh1 * (-_tmp67 * _tmp72 + _tmp69 * _tmp73);
  const Scalar _tmp75 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp76 =
      -Scalar(0.010999999999999999) * _tmp19 - Scalar(0.010999999999999999) * _tmp25;
  const Scalar _tmp77 = Scalar(0.20999999999999999) * _tmp16 + Scalar(0.20999999999999999) * _tmp17;
  const Scalar _tmp78 = Scalar(0.20999999999999999) * _tmp27 - Scalar(0.20999999999999999) * _tmp28;
  const Scalar _tmp79 = _tmp76 + _tmp77 - _tmp78;
  const Scalar _tmp80 = _tmp35 * _tmp79;
  const Scalar _tmp81 = _tmp76 + _tmp78;
  const Scalar _tmp82 = -_tmp77 + _tmp81;
  const Scalar _tmp83 = _tmp44 * _tmp79;
  const Scalar _tmp84 = _tmp56 * _tmp82 - _tmp58 * _tmp83;
  const Scalar _tmp85 = _tmp77 + _tmp81;
  const Scalar _tmp86 = Scalar(1.0) * _tmp46;
  const Scalar _tmp87 = Scalar(1.0) * _tmp49;
  const Scalar _tmp88 = (-_tmp38 + _tmp87) / (_tmp41 - _tmp86);
  const Scalar _tmp89 = -_tmp44 * _tmp82 + _tmp83;
  const Scalar _tmp90 = -_tmp35 * _tmp85 - _tmp61 * _tmp89 + _tmp80 -
                        _tmp88 * (_tmp36 * _tmp85 - _tmp58 * _tmp80 - _tmp61 * _tmp84);
  const Scalar _tmp91 = Scalar(1.0) / (_tmp90);
  const Scalar _tmp92 = _tmp86 * _tmp88 + _tmp87;
  const Scalar _tmp93 = 0;
  const Scalar _tmp94 = _tmp58 * _tmp59;
  const Scalar _tmp95 = -_tmp79 - _tmp88 * (_tmp58 * _tmp79 + _tmp84 * _tmp94) + _tmp89 * _tmp94;
  const Scalar _tmp96 = _tmp62 * _tmp91;
  const Scalar _tmp97 = _tmp63 * _tmp90;
  const Scalar _tmp98 = _tmp95 + _tmp97 * (-_tmp55 + _tmp57 * _tmp94 - _tmp95 * _tmp96);
  const Scalar _tmp99 = _tmp35 * _tmp91;
  const Scalar _tmp100 = _tmp60 * _tmp91;
  const Scalar _tmp101 = -_tmp100 * _tmp98 - _tmp58;
  const Scalar _tmp102 = _tmp44 * _tmp59;
  const Scalar _tmp103 = _tmp54 * fh1;
  const Scalar _tmp104 = _tmp65 * _tmp84 * _tmp88 - _tmp65 * _tmp89;
  const Scalar _tmp105 = _tmp104 + _tmp97 * (-_tmp104 * _tmp96 - _tmp57 * _tmp65);
  const Scalar _tmp106 = -_tmp100 * _tmp105 + Scalar(1.0);
  const Scalar _tmp107 = _tmp75 * _tmp93;
  const Scalar _tmp108 = _tmp59 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp103 * _tmp72 * (_tmp101 * _tmp102 + _tmp98 * _tmp99 + Scalar(1.0)) +
                        _tmp103 * _tmp73 * (_tmp102 * _tmp106 + _tmp105 * _tmp99) +
                        _tmp54 * _tmp74 * (_tmp35 * _tmp64 - _tmp44 * _tmp66) +
                        _tmp54 * _tmp75 * (_tmp35 * _tmp93 - _tmp44 * _tmp61 * _tmp93));
  _res(2, 0) = std::exp(-_tmp101 * _tmp108 * _tmp72 - _tmp106 * _tmp108 * _tmp73 +
                        _tmp107 * _tmp61 + _tmp66 * _tmp74);
  _res(3, 0) =
      std::exp(-_tmp105 * _tmp109 * _tmp73 - _tmp107 - _tmp109 * _tmp72 * _tmp98 - _tmp64 * _tmp74);
