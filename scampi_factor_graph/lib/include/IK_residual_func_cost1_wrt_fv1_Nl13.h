...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl13(
  ...
  const Scalar _tmp31 = 2 * _tmp11 * _tmp13;
  ...
  const Scalar _tmp36 = Scalar(0.20999999999999999) * _tmp12 +
  ...
  const Scalar _tmp56 = _tmp48 * _tmp49;
  const Scalar _tmp57 = -_tmp26;
  ...
  const Scalar _tmp62 = _tmp34 - _tmp36;
  ...
  const Scalar _tmp80 = _tmp52 + _tmp53;
  const Scalar _tmp81 = _tmp68 + _tmp80;
  const Scalar _tmp82 = _tmp73 * _tmp77;
  const Scalar _tmp83 = -_tmp67 * _tmp79 + _tmp81 * _tmp82;
  const Scalar _tmp84 = _tmp50 * _tmp67 - _tmp56;
  const Scalar _tmp85 = Scalar(1.0) / (_tmp67 * _tmp78 - _tmp82);
  const Scalar _tmp86 = _tmp84 * _tmp85;
  const Scalar _tmp87 = _tmp55 * _tmp56 - _tmp67 * _tmp70 - _tmp83 * _tmp86;
  ...
  const Scalar _tmp94 = -_tmp78 * _tmp81 + _tmp79;
  const Scalar _tmp95 = -_tmp50 * _tmp55 + _tmp70 - _tmp86 * _tmp94 - _tmp87 * _tmp93;
  ...
  const Scalar _tmp103 = _tmp102 * (-_tmp100 * _tmp78 + _tmp50 * _tmp99);
  const Scalar _tmp104 = Scalar(1.0) / (_tmp101);
  const Scalar _tmp105 = _tmp102 * (-_tmp104 * _tmp59 * _tmp65 + _tmp104 * _tmp61 * _tmp63);
  const Scalar _tmp106 = _tmp67 * _tmp85;
  const Scalar _tmp107 = _tmp106 * _tmp83 + _tmp67 * _tmp69;
  const Scalar _tmp108 = _tmp106 * _tmp94 - _tmp107 * _tmp93 - _tmp69;
  const Scalar _tmp109 = _tmp105 * _tmp78 + _tmp71 * _tmp78 - _tmp74 * _tmp82;
  const Scalar _tmp110 = _tmp105 * _tmp50 - _tmp109 * _tmp86 - _tmp42 * _tmp56 + _tmp46 * _tmp50;
  const Scalar _tmp111 = _tmp110 * _tmp96;
  const Scalar _tmp112 = Scalar(1.0) / (_tmp110);
  const Scalar _tmp113 = _tmp112 * _tmp95;
  const Scalar _tmp114 = _tmp113 * (-_tmp105 + _tmp106 * _tmp109 - _tmp108 * _tmp111);
  const Scalar _tmp115 = _tmp108 + _tmp114;
  const Scalar _tmp116 = _tmp84 * _tmp96;
  const Scalar _tmp117 = -_tmp115 * _tmp116 - _tmp67;
  const Scalar _tmp118 = _tmp78 * _tmp85;
  const Scalar _tmp119 = _tmp50 * _tmp96;
  const Scalar _tmp120 = _tmp39 + Scalar(-2.71799795);
  ...
  const Scalar _tmp127 = -_tmp125 * _tmp94 + _tmp126 * _tmp83 * _tmp85 * _tmp92;
  const Scalar _tmp128 = _tmp113 * (-_tmp109 * _tmp125 - _tmp111 * _tmp127);
  const Scalar _tmp129 = _tmp127 + _tmp128;
  const Scalar _tmp130 = -_tmp116 * _tmp129 + Scalar(1.0);
  const Scalar _tmp131 = _tmp121 * _tmp122;
  const Scalar _tmp132 = _tmp131 * fh1;
  const Scalar _tmp133 = Scalar(1.0) * _tmp112;
  const Scalar _tmp134 = fh1 * (-_tmp123 * _tmp28 + _tmp131 * _tmp38);
  const Scalar _tmp135 =
      -_tmp102 * _tmp124 * (_tmp115 * _tmp119 + _tmp117 * _tmp118 + Scalar(1.0)) -
      _tmp102 * _tmp132 * (_tmp118 * _tmp130 + _tmp119 * _tmp129) -
      _tmp102 * _tmp134 * (_tmp133 * _tmp50 - _tmp133 * _tmp78 * _tmp86) - _tmp103 * _tmp40;
  const Scalar _tmp136 = std::pow(_tmp135, Scalar(-2));
  const Scalar _tmp137 = _tmp103 * _tmp136;
  const Scalar _tmp138 = _tmp46 + _tmp89;
  const Scalar _tmp139 = _tmp138 * _tmp93;
  const Scalar _tmp140 = Scalar(1.0) / (-_tmp139 - _tmp42 + _tmp91);
  const Scalar _tmp141 = Scalar(1.0) * _tmp140;
  const Scalar _tmp142 = _tmp87 * _tmp96;
  const Scalar _tmp143 = _tmp138 * _tmp140;
  const Scalar _tmp144 = -_tmp125 * _tmp83 + _tmp128 * _tmp143 - _tmp129 * _tmp142;
  const Scalar _tmp145 = fh1 * (_tmp51 + _tmp80);
  const Scalar _tmp146 = -_tmp131 * _tmp145 - Scalar(3.29616) * _tmp21 - _tmp28 * fv1;
  const Scalar _tmp147 = _tmp141 * _tmp93;
  const Scalar _tmp148 = _tmp139 * _tmp141 + Scalar(1.0);
  const Scalar _tmp149 = -Scalar(1.0) * _tmp126 * _tmp148 + Scalar(1.0) * _tmp147;
  const Scalar _tmp150 = _tmp113 * _tmp141;
  const Scalar _tmp151 = -_tmp133 * _tmp87 + _tmp138 * _tmp150;
  const Scalar _tmp152 = _tmp123 * _tmp145 + Scalar(3.29616) * _tmp33 + _tmp38 * fv1;
  const Scalar _tmp153 = _tmp138 * _tmp90;
  const Scalar _tmp154 = Scalar(1.0) * _tmp141 * _tmp153 - Scalar(1.0) * _tmp141;
  const Scalar _tmp155 = _tmp140 * _tmp97;
  const Scalar _tmp156 = _tmp90 * (-_tmp138 * _tmp155 - _tmp142 * _tmp98 + _tmp89);
  const Scalar _tmp157 = -Scalar(1.0) * _tmp155 - Scalar(1.0) * _tmp156 + Scalar(1.0);
  const Scalar _tmp158 = _tmp107 + _tmp114 * _tmp143 - _tmp115 * _tmp142;
  const Scalar _tmp159 = Scalar(1.0) * _tmp124 * (_tmp114 * _tmp141 - _tmp126 * _tmp158) +
                         Scalar(1.0) * _tmp132 * (-_tmp126 * _tmp144 + _tmp128 * _tmp141) +
                         Scalar(1.0) * _tmp134 * (-_tmp126 * _tmp151 + _tmp150) +
                         _tmp146 * _tmp149 + _tmp152 * _tmp154 + _tmp157 * _tmp40;
  const Scalar _tmp160 = Scalar(1.0) / (_tmp135);
  const Scalar _tmp161 = std::asinh(_tmp159 * _tmp160);
  const Scalar _tmp162 = Scalar(1.0) * _tmp161;
  const Scalar _tmp163 = _tmp22 + _tmp58;
  const Scalar _tmp164 =
      (-_tmp137 * _tmp159 + _tmp160 * (_tmp149 * _tmp163 + _tmp154 * _tmp38 - _tmp157)) /
      std::sqrt(Scalar(_tmp136 * std::pow(_tmp159, Scalar(2)) + 1));
  ...
  const Scalar _tmp169 = Scalar(9.6622558468725703) * _tmp103;
  const Scalar _tmp170 = _tmp133 * _tmp134;
  const Scalar _tmp171 = _tmp40 * _tmp99;
  const Scalar _tmp172 =
      _tmp117 * _tmp124 * _tmp85 + _tmp130 * _tmp132 * _tmp85 - _tmp170 * _tmp86 - _tmp171 * _tmp86;
  const Scalar _tmp173 = Scalar(1.0) / (_tmp172);
  const Scalar _tmp174 = _tmp148 * _tmp90;
  const Scalar _tmp175 = _tmp141 * _tmp152;
  const Scalar _tmp176 = _tmp124 * _tmp158 * _tmp90 + _tmp132 * _tmp144 * _tmp90 +
                         _tmp134 * _tmp151 * _tmp90 + _tmp146 * _tmp174 - _tmp153 * _tmp175 +
                         _tmp156 * _tmp40;
  ...
  const Scalar _tmp183 = Scalar(9.6622558468725703) * _tmp99;
  const Scalar _tmp184 = _tmp183 * _tmp86;
  const Scalar _tmp185 = std::pow(_tmp172, Scalar(-2));
  const Scalar _tmp186 = _tmp100 * _tmp185;
  const Scalar _tmp187 = _tmp141 * _tmp38;
  const Scalar _tmp188 =
      (_tmp173 * (-_tmp153 * _tmp187 - _tmp156 + _tmp163 * _tmp174) - _tmp176 * _tmp186) /
      std::sqrt(Scalar(std::pow(_tmp176, Scalar(2)) * _tmp185 + 1));
  const Scalar _tmp189 =
      _tmp115 * _tmp124 * _tmp96 + _tmp129 * _tmp132 * _tmp96 + _tmp170 + _tmp171;
  const Scalar _tmp190 = std::pow(_tmp189, Scalar(-2));
  const Scalar _tmp191 = _tmp190 * _tmp99;
  const Scalar _tmp192 = -_tmp114 * _tmp124 * _tmp140 - _tmp128 * _tmp132 * _tmp140 -
                         _tmp134 * _tmp150 - _tmp146 * _tmp147 + _tmp155 * _tmp40 + _tmp175;
  ...
  const Scalar _tmp199 = (_tmp191 * _tmp192 + _tmp193 * (-_tmp147 * _tmp163 - _tmp155 + _tmp187)) /
  ...
  _res(1, 0) =
      -_tmp165 *
          (-Scalar(0.87679799772039002) * _tmp137 + Scalar(1.0) * _tmp164 * std::sinh(_tmp162) -
           (-Scalar(0.1034955) * _tmp137 * _tmp166 +
            _tmp167 * (-_tmp161 * _tmp169 - _tmp164 * _tmp165)) *
               std::sinh(_tmp168)) -
      _tmp169 * (Scalar(0.87679799772039002) * _tmp160 + std::cosh(_tmp162) - std::cosh(_tmp168));
  _res(2, 0) =
      -_tmp178 *
          (-Scalar(0.86625939559540499) * _tmp186 + Scalar(1.0) * _tmp188 * std::sinh(_tmp182) -
           (-Scalar(0.1034955) * _tmp179 * _tmp186 +
            _tmp180 * (-_tmp177 * _tmp184 - _tmp178 * _tmp188)) *
               std::sinh(_tmp181)) -
      _tmp184 * (Scalar(0.86625939559540499) * _tmp173 - std::cosh(_tmp181) + std::cosh(_tmp182));
  _res(3, 0) =
      _tmp183 * (Scalar(0.87653584775870996) * _tmp193 - std::cosh(_tmp198) + std::cosh(_tmp200)) -
      _tmp195 *
          (Scalar(0.87653584775870996) * _tmp191 + Scalar(1.0) * _tmp199 * std::sinh(_tmp200) -
           (Scalar(0.1034955) * _tmp191 * _tmp196 +
            _tmp197 * (_tmp183 * _tmp194 - _tmp195 * _tmp199)) *
               std::sinh(_tmp198));
