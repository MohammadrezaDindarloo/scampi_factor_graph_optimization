...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl7(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp32 = _tmp31 + p_init0 + Scalar(1.79662371);
  ...
  const Scalar _tmp45 = _tmp44 * (_tmp36 * _tmp40 * _tmp42 - _tmp37 * _tmp39 * _tmp42);
  const Scalar _tmp46 = _tmp23 * _tmp33;
  const Scalar _tmp47 = _tmp22 * _tmp34 - _tmp31 * _tmp46 + _tmp34 * _tmp45;
  const Scalar _tmp48 = _tmp40 * _tmp43;
  const Scalar _tmp49 = Scalar(1.0) / (_tmp34 * _tmp48 - _tmp46);
  const Scalar _tmp50 = Scalar(1.0) * _tmp49;
  const Scalar _tmp51 = Scalar(0.20999999999999999) * _tmp13 + Scalar(0.20999999999999999) * _tmp15;
  const Scalar _tmp52 =
  ...
  const Scalar _tmp58 = _tmp46 * _tmp57 - _tmp48 * _tmp56;
  const Scalar _tmp59 = Scalar(1.0) * _tmp39;
  const Scalar _tmp60 = Scalar(1.0) * _tmp36;
  const Scalar _tmp61 = (-_tmp31 + _tmp60) / (_tmp22 - _tmp59);
  const Scalar _tmp62 = -_tmp34 * _tmp57 + _tmp56;
  const Scalar _tmp63 = _tmp50 * _tmp58 * _tmp61 - _tmp50 * _tmp62;
  const Scalar _tmp64 = _tmp16 + _tmp20;
  const Scalar _tmp65 = _tmp11 + _tmp64;
  const Scalar _tmp66 = _tmp65 + p_init1 + Scalar(-4.7752063900000001);
  const Scalar _tmp67 = _tmp26 + _tmp29;
  ...
  const Scalar _tmp73 = _tmp51 + _tmp52 + _tmp53;
  const Scalar _tmp74 = _tmp66 * _tmp70;
  const Scalar _tmp75 = _tmp48 * _tmp71 - _tmp74;
  const Scalar _tmp76 = _tmp49 * _tmp75;
  const Scalar _tmp77 = -_tmp61 * (-_tmp48 * _tmp72 - _tmp58 * _tmp76 + _tmp73 * _tmp74) -
                        _tmp62 * _tmp76 - _tmp71 * _tmp73 + _tmp72;
  const Scalar _tmp78 = Scalar(1.0) / (_tmp77);
  const Scalar _tmp79 = _tmp45 * _tmp71 - _tmp47 * _tmp76 + _tmp65 * _tmp71 - _tmp68 * _tmp74;
  const Scalar _tmp80 = _tmp78 * _tmp79;
  const Scalar _tmp81 = Scalar(1.0) / (_tmp79);
  const Scalar _tmp82 = _tmp77 * _tmp81;
  const Scalar _tmp83 = _tmp63 + _tmp82 * (-_tmp47 * _tmp50 - _tmp63 * _tmp80);
  const Scalar _tmp84 = _tmp75 * _tmp78;
  const Scalar _tmp85 = -_tmp83 * _tmp84 + Scalar(1.0);
  const Scalar _tmp86 = _tmp34 * _tmp49;
  const Scalar _tmp87 = _tmp71 * _tmp78;
  const Scalar _tmp88 = _tmp35 + _tmp67;
  const Scalar _tmp89 = _tmp88 + p_init0 + Scalar(-2.5202214700000001);
  const Scalar _tmp90 = _tmp38 + _tmp64;
  ...
  const Scalar _tmp95 = _tmp48 * _tmp49;
  const Scalar _tmp96 = -_tmp55 - _tmp61 * (_tmp48 * _tmp55 + _tmp58 * _tmp95) + _tmp62 * _tmp95;
  const Scalar _tmp97 = _tmp82 * (-_tmp45 + _tmp47 * _tmp95 - _tmp80 * _tmp96) + _tmp96;
  const Scalar _tmp98 = -_tmp48 - _tmp84 * _tmp97;
  ...
  const Scalar _tmp104 = _tmp34 * _tmp76;
  const Scalar _tmp105 = Scalar(1.0) * _tmp81;
  const Scalar _tmp106 = fh1 * (_tmp88 * _tmp93 - _tmp90 * _tmp99);
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp44 * (_tmp86 * _tmp98 + _tmp87 * _tmp97 + Scalar(1.0)) +
                        _tmp101 * _tmp44 * (-_tmp103 * _tmp104 + _tmp103 * _tmp71) +
                        _tmp106 * _tmp44 * (-_tmp104 * _tmp105 + _tmp105 * _tmp71) +
                        _tmp44 * _tmp94 * (_tmp83 * _tmp87 + _tmp85 * _tmp86));
  _res(2, 0) = std::exp(-_tmp100 * _tmp49 * _tmp98 + _tmp107 * _tmp76 + _tmp108 * _tmp76 -
                        _tmp49 * _tmp85 * _tmp94);
  _res(3, 0) = std::exp(-_tmp100 * _tmp78 * _tmp97 - _tmp107 - _tmp108 - _tmp78 * _tmp83 * _tmp94);
