...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl15(
  ...
  const Scalar _tmp31 = _tmp13 * _tmp8;
  const Scalar _tmp32 = 2 * _tmp11 * _tmp7;
  const Scalar _tmp33 =
      -Scalar(0.010999999999999999) * _tmp31 - Scalar(0.010999999999999999) * _tmp32;
  const Scalar _tmp34 = Scalar(0.20999999999999999) * _tmp10 - Scalar(0.20999999999999999) * _tmp14;
  ...
  const Scalar _tmp40 = (-_tmp36 + _tmp39) / (-_tmp24 + _tmp27);
  ...
  const Scalar _tmp46 = _tmp36 + p_init0 + Scalar(1.79662371);
  ...
  const Scalar _tmp64 = _tmp30 + _tmp37;
  ...
  const Scalar _tmp71 = _tmp44 * _tmp55;
  const Scalar _tmp72 = -_tmp40 * (-_tmp59 * _tmp69 - _tmp67 * _tmp71 + _tmp68 * _tmp70) +
                        _tmp55 * _tmp67 - _tmp60 * _tmp69 - _tmp67 * _tmp70;
  ...
  const Scalar _tmp78 = _tmp50 * (_tmp27 * _tmp48 - _tmp36 * _tmp49 + _tmp48 * _tmp77);
  ...
  const Scalar _tmp87 = _tmp15 + _tmp26;
  const Scalar _tmp88 = _tmp87 + p_init1 + Scalar(-4.7752063900000001);
  const Scalar _tmp89 = _tmp29 + _tmp35;
  ...
  const Scalar _tmp93 = _tmp76 * _tmp92 * (_tmp48 * _tmp86 + _tmp83 * _tmp84);
  const Scalar _tmp94 = _tmp90 * _tmp91;
  const Scalar _tmp95 = -_tmp87 * _tmp94 + _tmp89 * _tmp92;
  const Scalar _tmp96 = Scalar(1.0) * _tmp81;
  const Scalar _tmp97 = _tmp50 * _tmp69;
  const Scalar _tmp98 = _tmp76 * _tmp95 * (-_tmp48 * _tmp96 * _tmp97 + _tmp67 * _tmp96);
  const Scalar _tmp99 = -_tmp40 * (_tmp44 * _tmp59 + _tmp71) + _tmp44 * _tmp60 - _tmp55;
  const Scalar _tmp100 = _tmp82 * (_tmp44 * _tmp78 - _tmp77 - _tmp80 * _tmp99) + _tmp99;
  const Scalar _tmp101 = _tmp50 * (-_tmp100 * _tmp85 - _tmp44);
  const Scalar _tmp102 = _tmp76 * _tmp94 * (_tmp100 * _tmp84 + _tmp101 * _tmp48 + Scalar(1.0));
  const Scalar _tmp103 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp104 = _tmp24 * _tmp40 + _tmp39;
  const Scalar _tmp105 = 0;
  const Scalar _tmp106 = _tmp105 * _tmp50 * _tmp85;
  const Scalar _tmp107 = _tmp105 * _tmp73;
  const Scalar _tmp108 = _tmp101 * _tmp94;
  const Scalar _tmp109 = _tmp95 * _tmp96;
  const Scalar _tmp110 = _tmp109 * fh1;
  const Scalar _tmp111 = _tmp86 * _tmp92;
  const Scalar _tmp112 = _tmp73 * _tmp83 * _tmp92;
  const Scalar _tmp113 = _tmp100 * _tmp73 * _tmp94;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp102 - _tmp93 - _tmp98) *
               std::exp(_tmp102 * fh1 + _tmp103 * _tmp76 * (-_tmp106 * _tmp48 + _tmp107 * _tmp67) +
                        _tmp93 * fh1 + _tmp98 * fh1);
  _res(2, 0) = -(_tmp108 - _tmp109 * _tmp97 + _tmp111) *
               std::exp(_tmp103 * _tmp106 - _tmp108 * fh1 + _tmp110 * _tmp97 - _tmp111 * fh1);
  _res(3, 0) = -(_tmp109 + _tmp112 + _tmp113) *
               std::exp(-_tmp103 * _tmp107 - _tmp110 - _tmp112 * fh1 - _tmp113 * fh1);
