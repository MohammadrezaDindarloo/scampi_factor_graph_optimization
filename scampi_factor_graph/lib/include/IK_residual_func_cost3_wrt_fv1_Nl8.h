...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl8(
  ...
  const Scalar _tmp30 = 2 * _tmp11 * _tmp7;
  const Scalar _tmp31 = _tmp12 * _tmp9;
  const Scalar _tmp32 =
      -Scalar(0.010999999999999999) * _tmp30 + Scalar(0.010999999999999999) * _tmp31;
  const Scalar _tmp33 = Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp14;
  ...
  const Scalar _tmp70 = _tmp48 * _tmp54;
  const Scalar _tmp71 = _tmp67 * _tmp68;
  const Scalar _tmp72 = _tmp48 * _tmp71 - _tmp69;
  const Scalar _tmp73 = _tmp50 * _tmp72;
  const Scalar _tmp74 = -_tmp40 * (-_tmp58 * _tmp73 + _tmp63 * _tmp69 - _tmp70 * _tmp71) +
                        _tmp54 * _tmp71 - _tmp60 * _tmp73 - _tmp63 * _tmp71;
  ...
  const Scalar _tmp81 = _tmp64 * _tmp71 - _tmp66 * _tmp69 + _tmp71 * _tmp79 - _tmp72 * _tmp80;
  ...
  const Scalar _tmp89 = _tmp71 * _tmp75;
  ...
  const Scalar _tmp96 = _tmp78 * fh1;
  const Scalar _tmp97 = -_tmp40 * (_tmp48 * _tmp59 + _tmp70) + _tmp48 * _tmp61 - _tmp54;
  ...
  const Scalar _tmp102 = _tmp27 + _tmp36 * _tmp40;
  const Scalar _tmp103 = 0;
  const Scalar _tmp104 = _tmp103 * _tmp73;
  const Scalar _tmp105 = _tmp78 * (_tmp103 * _tmp71 - _tmp104 * _tmp49);
  ...
  const Scalar _tmp109 = _tmp50 * fh1;
  const Scalar _tmp110 = _tmp106 * _tmp107;
  const Scalar _tmp111 = _tmp75 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp105 * std::exp(_tmp100 * _tmp96 * (_tmp88 * _tmp99 + _tmp89 * _tmp98 + Scalar(1.0)) +
                          _tmp101 * _tmp105 +
                          _tmp107 * _tmp78 * (-_tmp106 * _tmp49 * _tmp73 + _tmp106 * _tmp71) +
                          _tmp95 * _tmp96 * (_tmp85 * _tmp89 + _tmp87 * _tmp88));
  _res(2, 0) = -_tmp104 * std::exp(-_tmp100 * _tmp109 * _tmp99 + _tmp108 * _tmp73 -
                                   _tmp109 * _tmp87 * _tmp95 + _tmp110 * _tmp73);
  _res(3, 0) = _tmp103 * std::exp(-_tmp100 * _tmp111 * _tmp98 - _tmp108 - _tmp110 -
                                  _tmp111 * _tmp85 * _tmp95);
