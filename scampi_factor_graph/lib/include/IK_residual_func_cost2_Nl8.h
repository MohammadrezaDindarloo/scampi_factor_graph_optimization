...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl8(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp16 = 1 - 2 * std::pow(_tmp10, Scalar(2));
  const Scalar _tmp17 =
  ...
  const Scalar _tmp30 = _tmp11 * _tmp7;
  ...
  const Scalar _tmp39 = Scalar(0.20999999999999999) * _tmp15 +
  ...
  const Scalar _tmp43 = Scalar(6.351516257848961) *
  ...
  const Scalar _tmp48 = _tmp25 + _tmp32;
  ...
  const Scalar _tmp58 = _tmp57 * (-_tmp51 + _tmp53);
  const Scalar _tmp59 = _tmp49 * _tmp58 + _tmp53;
  const Scalar _tmp60 = _tmp35 + _tmp50;
  ...
  const Scalar _tmp69 = _tmp61 + p_init1;
  const Scalar _tmp70 = _tmp69 + Scalar(-4.8333311099999996);
  const Scalar _tmp71 = _tmp60 + p_init0;
  ...
  const Scalar _tmp86 = _tmp51 + p_init0;
  ...
  const Scalar _tmp93 = -_tmp80 * _tmp90 + _tmp91 * _tmp92;
  const Scalar _tmp94 = -_tmp74 + _tmp80 * _tmp82;
  const Scalar _tmp95 = Scalar(1.0) / (_tmp80 * _tmp89 - _tmp92);
  const Scalar _tmp96 = _tmp94 * _tmp95;
  const Scalar _tmp97 = _tmp68 * _tmp74 - _tmp80 * _tmp83 - _tmp93 * _tmp96;
  const Scalar _tmp98 = -_tmp89 * _tmp91 + _tmp90;
  const Scalar _tmp99 = -_tmp58 * _tmp97 - _tmp68 * _tmp82 + _tmp83 - _tmp96 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) / (_tmp99);
  const Scalar _tmp101 = 0;
  const Scalar _tmp102 = _tmp100 * _tmp101;
  const Scalar _tmp103 = -_tmp102 * _tmp97 + _tmp54 - _tmp62 * _tmp66;
  const Scalar _tmp104 = Scalar(1.0) * _tmp57;
  const Scalar _tmp105 = _tmp63 * _tmp65 + Scalar(1.0);
  const Scalar _tmp106 = _tmp58 * _tmp65;
  const Scalar _tmp107 = _tmp42 + Scalar(-2.5202214700000001);
  const Scalar _tmp108 = _tmp34 + Scalar(8.3888750099999996);
  const Scalar _tmp109 =
      std::pow(Scalar(std::pow(_tmp107, Scalar(2)) + std::pow(_tmp108, Scalar(2))),
               Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp110 = _tmp108 * _tmp109;
  const Scalar _tmp111 = _tmp23 * fh1;
  const Scalar _tmp112 = -_tmp110 * _tmp111 - Scalar(3.29616) * _tmp27 - _tmp33 * fv1;
  const Scalar _tmp113 = _tmp62 * _tmp65;
  const Scalar _tmp114 = _tmp107 * _tmp109;
  const Scalar _tmp115 = _tmp111 * _tmp114 + Scalar(3.29616) * _tmp37 + _tmp41 * fv1;
  const Scalar _tmp116 = Scalar(1.0) * _tmp95;
  const Scalar _tmp117 = _tmp116 * _tmp93;
  const Scalar _tmp118 = -_tmp116 * _tmp98 + _tmp117 * _tmp58;
  ...
  const Scalar _tmp121 = _tmp119 * _tmp77;
  const Scalar _tmp122 = _tmp121 * (-_tmp120 * _tmp48 * _tmp76 + _tmp120 * _tmp52 * _tmp79);
  const Scalar _tmp123 = _tmp95 * (_tmp122 * _tmp89 - _tmp51 * _tmp92 + _tmp56 * _tmp89);
  const Scalar _tmp124 = _tmp122 * _tmp82 - _tmp123 * _tmp94 - _tmp60 * _tmp74 + _tmp61 * _tmp82;
  const Scalar _tmp125 = _tmp100 * _tmp124;
  const Scalar _tmp126 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp127 = _tmp126 * _tmp99;
  const Scalar _tmp128 = _tmp127 * (-_tmp118 * _tmp125 - Scalar(1.0) * _tmp123);
  const Scalar _tmp129 = _tmp118 + _tmp128;
  const Scalar _tmp130 = _tmp100 * _tmp97;
  const Scalar _tmp131 = _tmp62 * _tmp64;
  const Scalar _tmp132 = -_tmp117 + _tmp128 * _tmp131 - _tmp129 * _tmp130;
  const Scalar _tmp133 = _tmp110 * fh1;
  const Scalar _tmp134 = _tmp127 * _tmp65;
  const Scalar _tmp135 = Scalar(1.0) * _tmp126;
  const Scalar _tmp136 = _tmp113 * _tmp127 - _tmp135 * _tmp97;
  const Scalar _tmp137 = fh1 * (_tmp110 * _tmp41 - _tmp114 * _tmp33);
  const Scalar _tmp138 = _tmp80 * _tmp95;
  const Scalar _tmp139 = _tmp138 * _tmp93 + _tmp80 * _tmp81;
  const Scalar _tmp140 = _tmp138 * _tmp98 - _tmp139 * _tmp58 - _tmp81;
  const Scalar _tmp141 = _tmp127 * (-_tmp122 + _tmp123 * _tmp80 - _tmp125 * _tmp140);
  const Scalar _tmp142 = _tmp140 + _tmp141;
  const Scalar _tmp143 = -_tmp130 * _tmp142 + _tmp131 * _tmp141 + _tmp139;
  const Scalar _tmp144 = _tmp114 * fh1;
  const Scalar _tmp145 = _tmp100 * _tmp94;
  const Scalar _tmp146 = -_tmp129 * _tmp145 + Scalar(1.0);
  const Scalar _tmp147 = _tmp89 * _tmp95;
  const Scalar _tmp148 = _tmp100 * _tmp82;
  const Scalar _tmp149 = -_tmp142 * _tmp145 - _tmp80;
  const Scalar _tmp150 = _tmp101 * _tmp145;
  const Scalar _tmp151 = -_tmp121 * _tmp133 * (_tmp129 * _tmp148 + _tmp146 * _tmp147) -
                         _tmp121 * _tmp137 * (_tmp135 * _tmp82 - _tmp135 * _tmp89 * _tmp96) -
                         _tmp121 * _tmp144 * (_tmp142 * _tmp148 + _tmp147 * _tmp149 + Scalar(1.0)) -
                         _tmp121 * _tmp47 * (_tmp102 * _tmp82 - _tmp147 * _tmp150);
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = std::asinh(
      _tmp152 * (Scalar(1.0) * _tmp112 * (-_tmp104 * _tmp105 + _tmp106) +
                 Scalar(1.0) * _tmp115 * (_tmp113 * _tmp57 - _tmp65) +
                 Scalar(1.0) * _tmp133 * (-_tmp104 * _tmp132 + _tmp128 * _tmp65) +
                 Scalar(1.0) * _tmp137 * (-_tmp104 * _tmp136 + _tmp134) +
                 Scalar(1.0) * _tmp144 * (-_tmp104 * _tmp143 + _tmp141 * _tmp65) +
                 Scalar(1.0) * _tmp47 * (-_tmp103 * _tmp104 - _tmp59 * _tmp65 + Scalar(1.0))));
  const Scalar _tmp154 = Scalar(7.3875128562042027) *
  ...
  const Scalar _tmp158 = _tmp133 * _tmp146 * _tmp95 + _tmp144 * _tmp149 * _tmp95 -
                         _tmp150 * _tmp47 * _tmp95 - _tmp157 * _tmp96;
  const Scalar _tmp159 = Scalar(1.0) / (_tmp158);
  const Scalar _tmp160 = _tmp115 * _tmp65;
  const Scalar _tmp161 =
      std::asinh(_tmp159 * (_tmp103 * _tmp47 * _tmp57 + _tmp105 * _tmp112 * _tmp57 +
                            _tmp132 * _tmp133 * _tmp57 + _tmp136 * _tmp137 * _tmp57 +
                            _tmp143 * _tmp144 * _tmp57 - _tmp160 * _tmp57 * _tmp62));
  ...
  const Scalar _tmp164 =
      _tmp100 * _tmp129 * _tmp133 + _tmp100 * _tmp142 * _tmp144 + _tmp102 * _tmp47 + _tmp157;
  const Scalar _tmp165 = Scalar(1.0) / (_tmp164);
  const Scalar _tmp166 =
      std::asinh(_tmp165 * (-_tmp106 * _tmp112 - _tmp128 * _tmp133 * _tmp64 - _tmp134 * _tmp137 -
                            _tmp141 * _tmp144 * _tmp64 + _tmp160 + _tmp47 * _tmp66));
  ...
  _res(0, 0) =
      ...
      Scalar(8.4693136199999994) *
          std::sqrt(Scalar(Scalar(0.013941309530580858) * _tmp43 +
  ...
  _res(1, 0) =
      ...
      Scalar(8.36416322) *
          std::sqrt(Scalar(Scalar(0.014294040284261563) * _tmp154 +
                           std::pow(Scalar(-Scalar(0.1195576860108189) * _tmp81 -
                                           Scalar(0.1195576860108189) * p_init2 + 1),
                                    Scalar(2))));
  _res(2, 0) =
      _tmp162 *
          (-std::sinh(Scalar(1.0) * _tmp161) -
           std::sinh(Scalar(0.1034955) * _tmp159 * (-std::sqrt(_tmp156) - _tmp161 * _tmp162))) -
