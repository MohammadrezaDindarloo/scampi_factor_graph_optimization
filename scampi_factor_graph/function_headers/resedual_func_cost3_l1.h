 ...
 *
 * Symbolic function: resedual_func_cost3_l1
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> ResedualFuncCost3L1(const Scalar fh1, const Scalar fv1, const Scalar rx,
  ...
  const Scalar _tmp23 = _tmp22 + p_init1 + Scalar(-4.7752063900000001);
  ...
  const Scalar _tmp27 = _tmp11 * _tmp7;
  const Scalar _tmp28 =
      -Scalar(0.010999999999999999) * _tmp26 - Scalar(0.010999999999999999) * _tmp27;
  const Scalar _tmp29 = -Scalar(0.20999999999999999) * _tmp12 + Scalar(0.20999999999999999) * _tmp9;
  const Scalar _tmp30 = _tmp28 + _tmp29;
  const Scalar _tmp31 = _tmp25 + _tmp30;
  const Scalar _tmp32 = _tmp31 + p_init0 + Scalar(-2.71799795);
  const Scalar _tmp33 = std::pow(Scalar(std::pow(_tmp23, Scalar(2)) + std::pow(_tmp32, Scalar(2))),
  ...
  const Scalar _tmp38 = _tmp17 - _tmp20;
  ...
  const Scalar _tmp48 = _tmp47 + p_init0 + Scalar(1.79662371);
  const Scalar _tmp49 = Scalar(1.0) / (_tmp48);
  const Scalar _tmp50 = _tmp45 * _tmp49;
  const Scalar _tmp51 = _tmp37 * _tmp41;
  const Scalar _tmp52 = -_tmp42 + _tmp50 * _tmp51;
  const Scalar _tmp53 = _tmp23 * _tmp33;
  const Scalar _tmp54 = Scalar(1.0) / (_tmp34 * _tmp50 - _tmp53);
  ...
  const Scalar _tmp58 = _tmp49 * _tmp56;
  const Scalar _tmp59 = _tmp58 * (-_tmp44 * _tmp48 * _tmp57 + _tmp45 * _tmp47 * _tmp57);
  const Scalar _tmp60 = _tmp22 * _tmp34 - _tmp31 * _tmp53 + _tmp34 * _tmp59;
  const Scalar _tmp61 = -_tmp36 * _tmp42 + _tmp39 * _tmp51 + _tmp51 * _tmp59 - _tmp55 * _tmp60;
  ...
  const Scalar _tmp66 = _tmp35 + _tmp46;
  ...
  const Scalar _tmp73 = Scalar(0.20999999999999999) * _tmp15 + Scalar(0.20999999999999999) * _tmp16;
  const Scalar _tmp74 =
  ...
  const Scalar _tmp81 = -_tmp34 * _tmp79 + _tmp53 * _tmp80;
  const Scalar _tmp82 = Scalar(1.0) * _tmp47;
  const Scalar _tmp83 = Scalar(1.0) * _tmp44;
  const Scalar _tmp84 = (-_tmp31 + _tmp82) / (_tmp22 - _tmp83);
  const Scalar _tmp85 = _tmp34 * _tmp78 - _tmp34 * _tmp80;
  const Scalar _tmp86 = -_tmp51 * _tmp77 + _tmp51 * _tmp78 - _tmp55 * _tmp85 -
                        _tmp84 * (_tmp42 * _tmp77 - _tmp51 * _tmp79 - _tmp55 * _tmp81);
  ...
  const Scalar _tmp92 = _tmp52 * _tmp87;
  const Scalar _tmp93 = _tmp89 * _tmp92;
  const Scalar _tmp94 = Scalar(1.0) * _tmp54;
  const Scalar _tmp95 = _tmp81 * _tmp84 * _tmp94 - _tmp85 * _tmp94;
  const Scalar _tmp96 = _tmp61 * _tmp87;
  const Scalar _tmp97 = _tmp62 * _tmp86;
  const Scalar _tmp98 = _tmp95 + _tmp97 * (-_tmp60 * _tmp94 - _tmp95 * _tmp96);
  const Scalar _tmp99 = -_tmp92 * _tmp98 + Scalar(1.0);
  const Scalar _tmp100 = _tmp51 * _tmp87;
  const Scalar _tmp101 = _tmp58 * fh1;
  const Scalar _tmp102 = _tmp50 * _tmp54;
  const Scalar _tmp103 = _tmp102 * _tmp85 - _tmp78 - _tmp84 * (_tmp102 * _tmp81 + _tmp79);
  const Scalar _tmp104 = _tmp103 + _tmp97 * (_tmp102 * _tmp60 - _tmp103 * _tmp96 - _tmp59);
  const Scalar _tmp105 = -_tmp104 * _tmp92 - _tmp50;
  const Scalar _tmp106 = _tmp54 * fh1;
  const Scalar _tmp107 = _tmp63 * _tmp71;
  const Scalar _tmp108 = _tmp87 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp101 * _tmp69 * (_tmp100 * _tmp104 + _tmp105 * _tmp91 + Scalar(1.0)) +
                        _tmp101 * _tmp70 * (_tmp100 * _tmp98 + _tmp91 * _tmp99) +
                        _tmp58 * _tmp71 * (-_tmp34 * _tmp55 * _tmp63 + _tmp51 * _tmp63) +
                        _tmp58 * _tmp72 * (_tmp51 * _tmp90 - _tmp91 * _tmp93));
  _res(2, 0) = std::exp(-_tmp105 * _tmp106 * _tmp69 - _tmp106 * _tmp70 * _tmp99 + _tmp107 * _tmp55 +
                        _tmp54 * _tmp72 * _tmp93);
  _res(3, 0) =
      std::exp(-_tmp104 * _tmp108 * _tmp69 - _tmp107 - _tmp108 * _tmp70 * _tmp98 - _tmp72 * _tmp90);
