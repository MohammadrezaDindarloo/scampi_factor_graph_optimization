...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl12(
  ...
  const Scalar _tmp10 = _tmp2 * rot_init_y + _tmp5 * rot_init_z + _tmp6 * ry - _tmp9 * rot_init_x;
  ...
  const Scalar _tmp13 = _tmp2 * rot_init_x - _tmp4 * rot_init_z + _tmp6 * rx + _tmp9 * rot_init_y;
  ...
  const Scalar _tmp25 = Scalar(0.20999999999999999) * _tmp14 + Scalar(0.20999999999999999) * _tmp16;
  const Scalar _tmp26 = -2 * std::pow(_tmp13, Scalar(2));
  ...
  const Scalar _tmp57 = -_tmp52;
  const Scalar _tmp58 = _tmp55 + _tmp57;
  const Scalar _tmp59 = _tmp35 * _tmp58;
  const Scalar _tmp60 = -_tmp35 * _tmp56 + _tmp59;
  const Scalar _tmp61 = _tmp47 * _tmp56 - _tmp49 * _tmp59;
  const Scalar _tmp62 = Scalar(1.0) * _tmp40;
  const Scalar _tmp63 = Scalar(1.0) * _tmp37;
  const Scalar _tmp64 = (-_tmp23 + _tmp63) / (_tmp32 - _tmp62);
  ...
  const Scalar _tmp75 = _tmp53 + _tmp54 + _tmp57;
  ...
  const Scalar _tmp101 = _tmp62 * _tmp64 + _tmp63;
  const Scalar _tmp102 = 0;
  const Scalar _tmp103 = _tmp102 * _tmp78;
  const Scalar _tmp104 = _tmp45 * (_tmp102 * _tmp73 - _tmp103 * _tmp35);
  const Scalar _tmp105 = _tmp49 * _tmp50;
  const Scalar _tmp106 = _tmp105 * _tmp60 - _tmp58 - _tmp64 * (_tmp105 * _tmp61 + _tmp49 * _tmp58);
  const Scalar _tmp107 = _tmp106 + _tmp84 * (_tmp105 * _tmp48 - _tmp106 * _tmp82 - _tmp46);
  const Scalar _tmp108 = -_tmp107 * _tmp87 - _tmp49;
  const Scalar _tmp109 = _tmp98 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp104 * std::exp(_tmp100 * _tmp104 +
                          _tmp109 * _tmp45 * (_tmp107 * _tmp86 + _tmp108 * _tmp89 + Scalar(1.0)) +
                          _tmp45 * _tmp96 * (_tmp85 * _tmp86 + _tmp88 * _tmp89) +
                          _tmp45 * _tmp99 * (-_tmp35 * _tmp78 * _tmp97 + _tmp73 * _tmp97));
  _res(2, 0) = -_tmp103 * std::exp(-_tmp108 * _tmp109 * _tmp50 + _tmp110 * _tmp78 +
                                   _tmp111 * _tmp78 - _tmp50 * _tmp88 * _tmp96);
  _res(3, 0) = _tmp102 *
               std::exp(-_tmp107 * _tmp109 * _tmp80 - _tmp110 - _tmp111 - _tmp80 * _tmp85 * _tmp96);
