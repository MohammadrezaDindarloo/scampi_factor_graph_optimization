...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl21(
  ...
  const Scalar _tmp16 = -_tmp12 * rz + _tmp5 * rot_init_y + _tmp7 * rot_init_w + _tmp8 * rot_init_z;
  ...
  const Scalar _tmp42 = -Scalar(0.010999999999999999) * _tmp11 -
                        Scalar(0.010999999999999999) * _tmp29 + Scalar(-0.010999999999999999);
  const Scalar _tmp43 = Scalar(0.20999999999999999) * _tmp17 + Scalar(0.20999999999999999) * _tmp19;
  ...
  const Scalar _tmp50 = _tmp30 + _tmp37;
  ...
  const Scalar _tmp77 = _tmp47 * _tmp54 - _tmp50 * _tmp76 + _tmp54 * _tmp75;
  const Scalar _tmp78 = _tmp70 * _tmp73;
  const Scalar _tmp79 = Scalar(1.0) / (_tmp54 * _tmp78 - _tmp76);
  const Scalar _tmp80 = _tmp58 * _tmp63;
  const Scalar _tmp81 = _tmp64 * _tmp78 - _tmp80;
  const Scalar _tmp82 = _tmp79 * _tmp81;
  const Scalar _tmp83 = _tmp56 * _tmp64 - _tmp60 * _tmp80 + _tmp64 * _tmp75 - _tmp77 * _tmp82;
  ...
  const Scalar _tmp88 = _tmp28 + Scalar(-4.8333311099999996);
  const Scalar _tmp89 = _tmp39 + Scalar(1.79662371);
  ...
  const Scalar _tmp93 = fh1 * (-_tmp27 * _tmp92 + _tmp38 * _tmp91);
  const Scalar _tmp94 = _tmp78 * _tmp79;
  const Scalar _tmp95 = _tmp42 - _tmp43;
  const Scalar _tmp96 = _tmp40 + _tmp95;
  const Scalar _tmp97 = _tmp54 * _tmp96;
  const Scalar _tmp98 = _tmp40 + _tmp44;
  const Scalar _tmp99 = -_tmp54 * _tmp98 + _tmp97;
  const Scalar _tmp100 = _tmp76 * _tmp98 - _tmp78 * _tmp97;
  const Scalar _tmp101 = _tmp100 * _tmp94 + _tmp78 * _tmp96;
  const Scalar _tmp102 = Scalar(1.0) * _tmp65;
  const Scalar _tmp103 = Scalar(1.0) * _tmp68;
  const Scalar _tmp104 = -_tmp103;
  const Scalar _tmp105 = Scalar(1.0) / (_tmp104 + _tmp47);
  const Scalar _tmp106 = _tmp105 * (_tmp102 - _tmp50);
  const Scalar _tmp107 = -_tmp101 * _tmp106 + _tmp94 * _tmp99 - _tmp96;
  const Scalar _tmp108 = _tmp41 + _tmp95;
  const Scalar _tmp109 = _tmp64 * _tmp96;
  const Scalar _tmp110 = -_tmp100 * _tmp82 + _tmp108 * _tmp80 - _tmp109 * _tmp78;
  const Scalar _tmp111 = -_tmp106 * _tmp110 - _tmp108 * _tmp64 + _tmp109 - _tmp82 * _tmp99;
  const Scalar _tmp112 = Scalar(1.0) / (_tmp111);
  const Scalar _tmp113 = _tmp112 * _tmp83;
  const Scalar _tmp114 = _tmp111 * _tmp84;
  const Scalar _tmp115 = _tmp114 * (-_tmp107 * _tmp113 - _tmp75 + _tmp77 * _tmp94);
  const Scalar _tmp116 = _tmp107 + _tmp115;
  const Scalar _tmp117 = _tmp112 * _tmp64;
  const Scalar _tmp118 = _tmp112 * _tmp81;
  const Scalar _tmp119 = -_tmp116 * _tmp118 - _tmp78;
  const Scalar _tmp120 = _tmp54 * _tmp79;
  const Scalar _tmp121 = _tmp92 * fh1;
  const Scalar _tmp122 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp123 = _tmp102 + _tmp103 * _tmp106;
  const Scalar _tmp124 = 0;
  const Scalar _tmp125 = _tmp100 * _tmp85;
  const Scalar _tmp126 = _tmp106 * _tmp125 - _tmp85 * _tmp99;
  const Scalar _tmp127 = _tmp114 * (-_tmp113 * _tmp126 - _tmp77 * _tmp85);
  const Scalar _tmp128 = _tmp126 + _tmp127;
  const Scalar _tmp129 = -_tmp118 * _tmp128 + Scalar(1.0);
  const Scalar _tmp130 = _tmp91 * fh1;
  const Scalar _tmp131 = -_tmp121 * _tmp74 * (_tmp116 * _tmp117 + _tmp119 * _tmp120 + Scalar(1.0)) -
                         _tmp122 * _tmp74 * (-_tmp124 * _tmp54 * _tmp82 + _tmp124 * _tmp64) -
                         _tmp130 * _tmp74 * (_tmp117 * _tmp128 + _tmp120 * _tmp129) -
                         _tmp74 * _tmp93 * (-_tmp54 * _tmp86 + _tmp64 * _tmp87);
  const Scalar _tmp132 = Scalar(1.0) / (_tmp131);
  const Scalar _tmp133 = _tmp104 + _tmp56;
  const Scalar _tmp134 = _tmp106 * _tmp133;
  const Scalar _tmp135 = Scalar(1.0) / (_tmp102 - _tmp134 - _tmp60);
  const Scalar _tmp136 = Scalar(1.0) * _tmp135;
  const Scalar _tmp137 = _tmp114 * _tmp136;
  const Scalar _tmp138 = -_tmp110 * _tmp87 + _tmp133 * _tmp137;
  const Scalar _tmp139 = Scalar(1.0) * _tmp105;
  const Scalar _tmp140 = _tmp110 * _tmp112;
  const Scalar _tmp141 = _tmp133 * _tmp135;
  const Scalar _tmp142 = _tmp101 + _tmp115 * _tmp141 - _tmp116 * _tmp140;
  const Scalar _tmp143 = _tmp105 * _tmp133;
  const Scalar _tmp144 = _tmp45 * fh1;
  const Scalar _tmp145 = _tmp144 * _tmp92 + Scalar(3.29616) * _tmp34 + _tmp38 * fv1;
  const Scalar _tmp146 = -_tmp125 + _tmp127 * _tmp141 - _tmp128 * _tmp140;
  const Scalar _tmp147 = _tmp123 * _tmp135;
  const Scalar _tmp148 = _tmp104 - _tmp110 * _tmp124 - _tmp133 * _tmp147;
  const Scalar _tmp149 = -_tmp144 * _tmp91 - Scalar(3.29616) * _tmp20 - _tmp27 * fv1;
  const Scalar _tmp150 = _tmp106 * _tmp136;
  const Scalar _tmp151 = _tmp134 * _tmp136 + Scalar(1.0);
  const Scalar _tmp152 = std::asinh(
      _tmp132 * (Scalar(1.0) * _tmp121 * (_tmp115 * _tmp136 - _tmp139 * _tmp142) +
                 Scalar(1.0) * _tmp122 * (-_tmp123 * _tmp136 - _tmp139 * _tmp148 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp130 * (_tmp127 * _tmp136 - _tmp139 * _tmp146) +
                 Scalar(1.0) * _tmp145 * (_tmp136 * _tmp143 - _tmp136) +
                 Scalar(1.0) * _tmp149 * (-_tmp139 * _tmp151 + _tmp150) +
                 Scalar(1.0) * _tmp93 * (_tmp137 - _tmp138 * _tmp139)));
  const Scalar _tmp153 = Scalar(9.6622558468725703) * _tmp131;
  const Scalar _tmp154 = _tmp122 * _tmp124;
  const Scalar _tmp155 =
      _tmp119 * _tmp121 * _tmp79 + _tmp129 * _tmp130 * _tmp79 - _tmp154 * _tmp82 - _tmp86 * _tmp93;
  const Scalar _tmp156 = Scalar(1.0) / (_tmp155);
  const Scalar _tmp157 = _tmp136 * _tmp145;
  const Scalar _tmp158 =
      std::asinh(_tmp156 * (_tmp105 * _tmp121 * _tmp142 + _tmp105 * _tmp122 * _tmp148 +
                            _tmp105 * _tmp130 * _tmp146 + _tmp105 * _tmp138 * _tmp93 +
                            _tmp105 * _tmp149 * _tmp151 - _tmp143 * _tmp157));
  const Scalar _tmp159 = Scalar(9.6622558468725703) * _tmp155;
  const Scalar _tmp160 =
      _tmp112 * _tmp116 * _tmp121 + _tmp112 * _tmp128 * _tmp130 + _tmp154 + _tmp87 * _tmp93;
  const Scalar _tmp161 = Scalar(1.0) / (_tmp160);
  const Scalar _tmp162 = std::asinh(_tmp161 * (-_tmp115 * _tmp121 * _tmp135 + _tmp122 * _tmp147 -
                                               _tmp127 * _tmp130 * _tmp135 - _tmp137 * _tmp93 -
                                               _tmp149 * _tmp150 + _tmp157));
