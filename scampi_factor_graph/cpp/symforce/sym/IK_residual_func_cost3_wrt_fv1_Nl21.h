...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl21(
  ...
  const Scalar _tmp49 = _tmp13 + _tmp22;
  ...
  const Scalar _tmp54 = Scalar(1.0) / (_tmp35 * _tmp52 - _tmp53);
  ...
  const Scalar _tmp58 = _tmp25 * _tmp56;
  const Scalar _tmp59 = _tmp58 * (_tmp23 * _tmp34 * _tmp57 - _tmp24 * _tmp33 * _tmp57);
  const Scalar _tmp60 = _tmp47 * _tmp52 - _tmp49 * _tmp53 + _tmp52 * _tmp59;
  const Scalar _tmp61 = _tmp37 * _tmp43 - _tmp40 * _tmp44 + _tmp43 * _tmp59 - _tmp55 * _tmp60;
  const Scalar _tmp62 = Scalar(1.0) / (_tmp61);
  const Scalar _tmp63 = Scalar(1.0) * _tmp62;
  const Scalar _tmp64 = _tmp13 + _tmp39;
  const Scalar _tmp65 = _tmp36 + _tmp46;
  const Scalar _tmp66 = _tmp65 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp67 = _tmp64 + p_init0 + Scalar(1.79662371);
  ...
  const Scalar _tmp72 = _tmp35 * _tmp54;
  const Scalar _tmp73 = Scalar(0.20999999999999999) * _tmp16 - Scalar(0.20999999999999999) * _tmp17;
  const Scalar _tmp74 =
      -Scalar(0.010999999999999999) * _tmp19 - Scalar(0.010999999999999999) * _tmp27;
  ...
  const Scalar _tmp79 = _tmp52 * _tmp77 - _tmp52 * _tmp78;
  const Scalar _tmp80 = _tmp35 * _tmp77;
  const Scalar _tmp81 = -_tmp52 * _tmp80 + _tmp53 * _tmp78;
  const Scalar _tmp82 = Scalar(1.0) * _tmp23;
  const Scalar _tmp83 = Scalar(1.0) * _tmp33;
  const Scalar _tmp84 = (-_tmp49 + _tmp82) / (_tmp47 - _tmp83);
  const Scalar _tmp85 = _tmp72 * _tmp79 - _tmp77 - _tmp84 * (_tmp72 * _tmp81 + _tmp80);
  const Scalar _tmp86 = -_tmp73 + _tmp76;
  const Scalar _tmp87 = _tmp43 * _tmp77;
  const Scalar _tmp88 = -_tmp43 * _tmp86 - _tmp55 * _tmp79 -
                        _tmp84 * (-_tmp35 * _tmp87 + _tmp44 * _tmp86 - _tmp55 * _tmp81) + _tmp87;
  const Scalar _tmp89 = Scalar(1.0) / (_tmp88);
  const Scalar _tmp90 = _tmp61 * _tmp89;
  const Scalar _tmp91 = _tmp62 * _tmp88;
  const Scalar _tmp92 = _tmp85 + _tmp91 * (-_tmp59 + _tmp60 * _tmp72 - _tmp85 * _tmp90);
  const Scalar _tmp93 = _tmp43 * _tmp89;
  const Scalar _tmp94 = _tmp45 * _tmp89;
  const Scalar _tmp95 = -_tmp35 - _tmp92 * _tmp94;
  const Scalar _tmp96 = _tmp52 * _tmp54;
  const Scalar _tmp97 = _tmp58 * fh1;
  const Scalar _tmp98 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp99 = _tmp82 + _tmp83 * _tmp84;
  const Scalar _tmp100 = 0;
  const Scalar _tmp101 = _tmp100 * _tmp55;
  const Scalar _tmp102 = _tmp58 * (_tmp100 * _tmp43 - _tmp101 * _tmp52);
  const Scalar _tmp103 = Scalar(1.0) * _tmp54;
  const Scalar _tmp104 = -_tmp103 * _tmp79 + _tmp103 * _tmp81 * _tmp84;
  const Scalar _tmp105 = _tmp104 + _tmp91 * (-_tmp103 * _tmp60 - _tmp104 * _tmp90);
  const Scalar _tmp106 = -_tmp105 * _tmp94 + Scalar(1.0);
  const Scalar _tmp107 = _tmp54 * fh1;
  const Scalar _tmp108 = _tmp100 * _tmp98;
  const Scalar _tmp109 = _tmp63 * _tmp71;
  const Scalar _tmp110 = _tmp89 * fh1;
  ...
  _res(1, 0) =
      -_tmp102 *
      std::exp(_tmp102 * _tmp98 + _tmp58 * _tmp71 * (_tmp43 * _tmp63 - _tmp52 * _tmp55 * _tmp63) +
               _tmp69 * _tmp97 * (_tmp105 * _tmp93 + _tmp106 * _tmp96) +
               _tmp70 * _tmp97 * (_tmp92 * _tmp93 + _tmp95 * _tmp96 + Scalar(1.0)));
  _res(2, 0) = -_tmp101 * std::exp(-_tmp106 * _tmp107 * _tmp69 - _tmp107 * _tmp70 * _tmp95 +
                                   _tmp108 * _tmp55 + _tmp109 * _tmp55);
  _res(3, 0) = _tmp100 * std::exp(-_tmp105 * _tmp110 * _tmp69 - _tmp108 - _tmp109 -
                                  _tmp110 * _tmp70 * _tmp92);
