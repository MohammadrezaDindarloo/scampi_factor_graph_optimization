...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl1(
  ...
  const Scalar _tmp37 = Scalar(0.20999999999999999) * _tmp13 - Scalar(0.20999999999999999) * _tmp15;
  ...
  const Scalar _tmp54 = Scalar(1.0) / (_tmp34 * _tmp49 - _tmp52);
  const Scalar _tmp55 = Scalar(1.0) * _tmp54;
  const Scalar _tmp56 = Scalar(1.0) * _tmp32;
  const Scalar _tmp57 = Scalar(1.0) * _tmp22;
  const Scalar _tmp58 = (-_tmp46 + _tmp57) / (_tmp42 - _tmp56);
  ...
  const Scalar _tmp72 = _tmp39 * _tmp66 -
                        _tmp58 * (-_tmp53 * _tmp69 - _tmp66 * _tmp71 + _tmp67 * _tmp70) -
  ...
  const Scalar _tmp86 = _tmp49 * _tmp54;
  ...
  const Scalar _tmp98 = _tmp34 * _tmp54;
  const Scalar _tmp99 = -_tmp39 - _tmp58 * (_tmp53 * _tmp98 + _tmp71) + _tmp59 * _tmp98;
  const Scalar _tmp100 = _tmp82 * (-_tmp77 + _tmp78 * _tmp98 - _tmp80 * _tmp99) + _tmp99;
  const Scalar _tmp101 = -_tmp100 * _tmp84 - _tmp34;
  const Scalar _tmp102 = _tmp96 * fh1;
  const Scalar _tmp103 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp104 = _tmp56 * _tmp58 + _tmp57;
  const Scalar _tmp105 = 0;
  const Scalar _tmp106 = _tmp105 * _tmp69;
  const Scalar _tmp107 = _tmp76 * (_tmp105 * _tmp66 - _tmp106 * _tmp49);
  ...
  _res(0, 0) = 0;
  _res(1, 0) = -_tmp107 *
               std::exp(_tmp102 * _tmp76 * (_tmp100 * _tmp87 + _tmp101 * _tmp86 + Scalar(1.0)) +
                        _tmp103 * _tmp107 + _tmp76 * _tmp94 * (_tmp83 * _tmp87 + _tmp85 * _tmp86) +
                        _tmp76 * _tmp97 * (-_tmp49 * _tmp69 * _tmp95 + _tmp66 * _tmp95));
  _res(2, 0) = -_tmp106 * std::exp(-_tmp101 * _tmp102 * _tmp54 + _tmp108 * _tmp69 +
                                   _tmp109 * _tmp69 - _tmp54 * _tmp85 * _tmp94);
  _res(3, 0) = _tmp105 *
               std::exp(-_tmp100 * _tmp102 * _tmp73 - _tmp108 - _tmp109 - _tmp73 * _tmp83 * _tmp94);
