...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl15(
  ...
  const Scalar _tmp29 = Scalar(0.20999999999999999) * _tmp15 + Scalar(0.20999999999999999) * _tmp28;
  const Scalar _tmp30 = _tmp17 * _tmp8;
  const Scalar _tmp31 = _tmp11 * _tmp7;
  const Scalar _tmp32 =
  ...
  const Scalar _tmp35 = -_tmp27;
  const Scalar _tmp36 = _tmp29 + _tmp32;
  const Scalar _tmp37 = _tmp35 + _tmp36;
  const Scalar _tmp38 = Scalar(1.0) * _tmp37;
  const Scalar _tmp39 = (-_tmp34 + _tmp38) / (-_tmp23 + _tmp26);
  const Scalar _tmp40 = _tmp37 + p_init0 + Scalar(-2.5202214700000001);
  const Scalar _tmp41 = Scalar(1.0) / (_tmp40);
  const Scalar _tmp42 = _tmp22 + p_init1 + Scalar(8.3888750099999996);
  const Scalar _tmp43 = _tmp41 * _tmp42;
  const Scalar _tmp44 = _tmp26 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp45 = _tmp34 + p_init0 + Scalar(1.79662371);
  ...
  const Scalar _tmp52 = Scalar(0.20999999999999999) * _tmp18 + Scalar(0.20999999999999999) * _tmp19;
  ...
  const Scalar _tmp58 = _tmp49 * (-_tmp43 * _tmp55 + _tmp48 * _tmp57);
  const Scalar _tmp59 = _tmp49 * (-_tmp47 * _tmp57 + _tmp55);
  const Scalar _tmp60 = Scalar(1.0) * _tmp39 * _tmp58 - Scalar(1.0) * _tmp59;
  const Scalar _tmp61 = _tmp21 + _tmp24;
  const Scalar _tmp62 = _tmp61 + p_init1 + Scalar(8.3196563700000006);
  const Scalar _tmp63 = _tmp33 + _tmp35;
  ...
  const Scalar _tmp68 = _tmp43 * _tmp66 - _tmp67;
  const Scalar _tmp69 = _tmp53 + _tmp56;
  const Scalar _tmp70 = _tmp54 * _tmp66;
  const Scalar _tmp71 = -_tmp39 * (-_tmp43 * _tmp70 - _tmp58 * _tmp68 + _tmp67 * _tmp69) -
                        _tmp59 * _tmp68 - _tmp66 * _tmp69 + _tmp70;
  ...
  const Scalar _tmp76 = _tmp75 * (-_tmp22 * _tmp40 * _tmp74 + _tmp37 * _tmp42 * _tmp74);
  const Scalar _tmp77 = _tmp49 * (_tmp26 * _tmp47 - _tmp34 * _tmp48 + _tmp47 * _tmp76);
  ...
  const Scalar _tmp84 = _tmp68 * _tmp72;
  const Scalar _tmp85 = -_tmp82 * _tmp84 + Scalar(1.0);
  const Scalar _tmp86 = _tmp47 * _tmp49;
  const Scalar _tmp87 = _tmp13 + _tmp25;
  const Scalar _tmp88 = _tmp87 + p_init1 + Scalar(-4.7752063900000001);
  const Scalar _tmp89 = _tmp27 + _tmp36;
  ...
  const Scalar _tmp97 = -_tmp39 * (_tmp43 * _tmp54 + _tmp43 * _tmp58) + _tmp43 * _tmp59 - _tmp54;
  const Scalar _tmp98 = _tmp81 * (_tmp43 * _tmp77 - _tmp76 - _tmp79 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp43 - _tmp84 * _tmp98;
  const Scalar _tmp100 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp101 = _tmp23 * _tmp39 + _tmp38;
  const Scalar _tmp102 = 0;
  const Scalar _tmp103 = _tmp102 * _tmp84;
  const Scalar _tmp104 = _tmp102 * _tmp72;
  const Scalar _tmp105 = _tmp49 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp75 * (-_tmp103 * _tmp86 + _tmp104 * _tmp66) +
                        _tmp75 * _tmp96 * (_tmp66 * _tmp94 - _tmp68 * _tmp86 * _tmp94) +
                        _tmp92 * _tmp93 * (_tmp82 * _tmp83 + _tmp85 * _tmp86) +
                        _tmp93 * _tmp95 * (_tmp83 * _tmp98 + _tmp86 * _tmp99 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp100 * _tmp103 * _tmp49 - _tmp105 * _tmp85 * _tmp92 -
                        _tmp105 * _tmp95 * _tmp99 + _tmp106 * _tmp49 * _tmp68);
  _res(3, 0) = std::exp(-_tmp100 * _tmp104 - _tmp106 - _tmp107 * _tmp82 * _tmp92 -
                        _tmp107 * _tmp95 * _tmp98);
