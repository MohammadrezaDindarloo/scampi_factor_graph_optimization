...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl19(
  ...
  const Scalar _tmp21 = _tmp12 * _tmp7;
  const Scalar _tmp22 =
  ...
  const Scalar _tmp25 = _tmp24 + p_init0 + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp30 = _tmp19 * _tmp7;
  const Scalar _tmp31 = _tmp12 * _tmp9;
  const Scalar _tmp32 =
  ...
  const Scalar _tmp35 = _tmp34 + p_init1 + Scalar(8.3196563700000006);
  const Scalar _tmp36 =
      std::sqrt(Scalar(std::pow(_tmp25, Scalar(2)) + std::pow(_tmp35, Scalar(2))));
  const Scalar _tmp37 = Scalar(1.0) / (_tmp36);
  const Scalar _tmp38 = Scalar(1.0) / (_tmp25);
  const Scalar _tmp39 = _tmp36 * _tmp38;
  const Scalar _tmp40 = _tmp39 * (_tmp24 * _tmp35 * _tmp37 - _tmp25 * _tmp34 * _tmp37);
  const Scalar _tmp41 = Scalar(0.20999999999999999) * _tmp20 - Scalar(0.20999999999999999) * _tmp21;
  const Scalar _tmp42 =
      -Scalar(0.010999999999999999) * _tmp17 - Scalar(0.010999999999999999) * _tmp28;
  ...
  const Scalar _tmp55 = _tmp41 + _tmp42 + _tmp43;
  const Scalar _tmp56 = -_tmp53 * _tmp55 + _tmp54;
  const Scalar _tmp57 = _tmp35 * _tmp38;
  const Scalar _tmp58 = _tmp48 * _tmp52;
  const Scalar _tmp59 = Scalar(1.0) / (_tmp53 * _tmp57 - _tmp58);
  const Scalar _tmp60 = _tmp57 * _tmp59;
  const Scalar _tmp61 = -_tmp54 * _tmp57 + _tmp55 * _tmp58;
  const Scalar _tmp62 = Scalar(1.0) * _tmp24;
  const Scalar _tmp63 = Scalar(1.0) * _tmp34;
  const Scalar _tmp64 = (-_tmp50 + _tmp62) / (_tmp47 - _tmp63);
  const Scalar _tmp65 = -_tmp45 + _tmp56 * _tmp60 - _tmp64 * (_tmp45 * _tmp57 + _tmp60 * _tmp61);
  const Scalar _tmp66 = _tmp41 + _tmp44;
  const Scalar _tmp67 = _tmp15 + _tmp49;
  const Scalar _tmp68 = _tmp67 + p_init0 + Scalar(-2.5202214700000001);
  const Scalar _tmp69 = _tmp26 + _tmp33;
  const Scalar _tmp70 = _tmp69 + p_init1 + Scalar(8.3888750099999996);
  ...
  const Scalar _tmp74 = _tmp57 * _tmp73 - _tmp72;
  const Scalar _tmp75 = _tmp59 * _tmp74;
  const Scalar _tmp76 = _tmp45 * _tmp73;
  const Scalar _tmp77 = -_tmp56 * _tmp75 -
                        _tmp64 * (-_tmp57 * _tmp76 - _tmp61 * _tmp75 + _tmp66 * _tmp72) -
                        _tmp66 * _tmp73 + _tmp76;
  const Scalar _tmp78 = Scalar(1.0) / (_tmp77);
  const Scalar _tmp79 = _tmp40 * _tmp53 + _tmp47 * _tmp53 - _tmp50 * _tmp58;
  const Scalar _tmp80 = _tmp40 * _tmp73 - _tmp67 * _tmp72 + _tmp69 * _tmp73 - _tmp75 * _tmp79;
  const Scalar _tmp81 = _tmp78 * _tmp80;
  const Scalar _tmp82 = Scalar(1.0) / (_tmp80);
  const Scalar _tmp83 = _tmp77 * _tmp82;
  const Scalar _tmp84 = _tmp65 + _tmp83 * (-_tmp40 + _tmp60 * _tmp79 - _tmp65 * _tmp81);
  const Scalar _tmp85 = _tmp73 * _tmp78;
  const Scalar _tmp86 = _tmp74 * _tmp78;
  const Scalar _tmp87 = -_tmp57 - _tmp84 * _tmp86;
  const Scalar _tmp88 = _tmp53 * _tmp59;
  const Scalar _tmp89 = _tmp27 + _tmp46;
  const Scalar _tmp90 = _tmp89 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp91 = _tmp14 + _tmp23;
  ...
  const Scalar _tmp95 = _tmp39 * fh1;
  ...
  const Scalar _tmp100 = -_tmp56 * _tmp99 + _tmp61 * _tmp64 * _tmp99;
  const Scalar _tmp101 = _tmp100 + _tmp83 * (-_tmp100 * _tmp81 - _tmp79 * _tmp99);
  const Scalar _tmp102 = -_tmp101 * _tmp86 + Scalar(1.0);
  const Scalar _tmp103 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp104 = _tmp62 + _tmp63 * _tmp64;
  const Scalar _tmp105 = 0;
  const Scalar _tmp106 = _tmp105 * _tmp75;
  const Scalar _tmp107 = _tmp39 * (_tmp105 * _tmp73 - _tmp106 * _tmp53);
  ...
  _res(1, 0) =
      -_tmp107 *
      std::exp(_tmp103 * _tmp107 + _tmp39 * _tmp98 * (-_tmp53 * _tmp75 * _tmp96 + _tmp73 * _tmp96) +
               _tmp94 * _tmp95 * (_tmp84 * _tmp85 + _tmp87 * _tmp88 + Scalar(1.0)) +
               _tmp95 * _tmp97 * (_tmp101 * _tmp85 + _tmp102 * _tmp88));
  _res(2, 0) = -_tmp106 * std::exp(-_tmp102 * _tmp108 * _tmp97 - _tmp108 * _tmp87 * _tmp94 +
                                   _tmp109 * _tmp75 + _tmp110 * _tmp75);
  _res(3, 0) = _tmp105 * std::exp(-_tmp101 * _tmp111 * _tmp97 - _tmp109 - _tmp110 -
                                  _tmp111 * _tmp84 * _tmp94);
