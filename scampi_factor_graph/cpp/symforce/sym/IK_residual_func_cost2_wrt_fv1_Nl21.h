...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl21(
  ...
  const Scalar _tmp27 = 1 - 2 * std::pow(_tmp12, Scalar(2));
  ...
  const Scalar _tmp35 = _tmp12 * _tmp17;
  const Scalar _tmp36 = 2 * _tmp11 * _tmp15;
  const Scalar _tmp37 = _tmp35 + _tmp36;
  const Scalar _tmp38 = -Scalar(0.010999999999999999) * _tmp37;
  const Scalar _tmp39 = Scalar(0.20999999999999999) * _tmp14 - Scalar(0.20999999999999999) * _tmp18;
  ...
  const Scalar _tmp58 = _tmp49 + Scalar(-2.5202214700000001);
  const Scalar _tmp59 = Scalar(1.0) / (_tmp58);
  const Scalar _tmp60 = _tmp46 + Scalar(8.3888750099999996);
  ...
  const Scalar _tmp65 = _tmp34 + _tmp47;
  ...
  const Scalar _tmp71 = _tmp61 * _tmp69 - _tmp70;
  const Scalar _tmp72 =
      std::sqrt(Scalar(std::pow(_tmp58, Scalar(2)) + std::pow(_tmp60, Scalar(2))));
  const Scalar _tmp73 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp74 = _tmp59 * _tmp72;
  const Scalar _tmp75 = _tmp74 * (-_tmp45 * _tmp58 * _tmp73 + _tmp48 * _tmp60 * _tmp73);
  const Scalar _tmp76 = _tmp52 * _tmp56;
  const Scalar _tmp77 = _tmp50 * _tmp57 - _tmp53 * _tmp76 + _tmp57 * _tmp75;
  const Scalar _tmp78 = Scalar(1.0) / (_tmp57 * _tmp61 - _tmp76);
  const Scalar _tmp79 = _tmp71 * _tmp78;
  const Scalar _tmp80 = _tmp62 * _tmp69 - _tmp65 * _tmp70 + _tmp69 * _tmp75 - _tmp77 * _tmp79;
  const Scalar _tmp81 = Scalar(1.0) / (_tmp80);
  const Scalar _tmp82 = Scalar(1.0) * _tmp78;
  const Scalar _tmp83 = _tmp71 * _tmp81 * _tmp82;
  ...
  const Scalar _tmp91 = _tmp61 * _tmp78;
  ...
  const Scalar _tmp102 = -_tmp61 * _tmp98 + _tmp76 * _tmp99;
  const Scalar _tmp103 = _tmp101 + _tmp102 * _tmp91;
  const Scalar _tmp104 = Scalar(1.0) * _tmp45;
  const Scalar _tmp105 = -_tmp104;
  const Scalar _tmp106 = Scalar(1.0) / (_tmp105 + _tmp50);
  const Scalar _tmp107 = Scalar(1.0) * _tmp48;
  const Scalar _tmp108 = _tmp106 * (_tmp107 - _tmp53);
  const Scalar _tmp109 = _tmp100 * _tmp91 - _tmp103 * _tmp108 - _tmp97;
  const Scalar _tmp110 = _tmp94 - _tmp95;
  const Scalar _tmp111 = _tmp110 + _tmp93;
  const Scalar _tmp112 = -_tmp101 * _tmp69 - _tmp102 * _tmp79 + _tmp111 * _tmp70;
  const Scalar _tmp113 = -_tmp100 * _tmp79 - _tmp108 * _tmp112 - _tmp111 * _tmp69 + _tmp69 * _tmp97;
  const Scalar _tmp114 = Scalar(1.0) / (_tmp113);
  const Scalar _tmp115 = _tmp114 * _tmp80;
  const Scalar _tmp116 = _tmp113 * _tmp81;
  const Scalar _tmp117 = _tmp116 * (-_tmp109 * _tmp115 - _tmp75 + _tmp77 * _tmp91);
  const Scalar _tmp118 = _tmp109 + _tmp117;
  const Scalar _tmp119 = _tmp114 * _tmp69;
  const Scalar _tmp120 = _tmp114 * _tmp71;
  const Scalar _tmp121 = -_tmp118 * _tmp120 - _tmp61;
  const Scalar _tmp122 = _tmp57 * _tmp78;
  const Scalar _tmp123 = _tmp89 * fh1;
  const Scalar _tmp124 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp125 = _tmp104 * _tmp108 + _tmp107;
  const Scalar _tmp126 = 0;
  const Scalar _tmp127 = _tmp126 * _tmp79;
  const Scalar _tmp128 = _tmp74 * (_tmp126 * _tmp69 - _tmp127 * _tmp57);
  const Scalar _tmp129 = _tmp102 * _tmp82;
  const Scalar _tmp130 = -_tmp100 * _tmp82 + _tmp108 * _tmp129;
  const Scalar _tmp131 = _tmp116 * (-_tmp115 * _tmp130 - _tmp77 * _tmp82);
  const Scalar _tmp132 = _tmp130 + _tmp131;
  const Scalar _tmp133 = -_tmp120 * _tmp132 + Scalar(1.0);
  const Scalar _tmp134 = _tmp88 * fh1;
  const Scalar _tmp135 = -_tmp123 * _tmp74 * (_tmp118 * _tmp119 + _tmp121 * _tmp122 + Scalar(1.0)) -
                         _tmp124 * _tmp128 -
                         _tmp134 * _tmp74 * (_tmp119 * _tmp132 + _tmp122 * _tmp133) -
                         _tmp74 * _tmp90 * (-_tmp57 * _tmp83 + _tmp69 * _tmp84);
  const Scalar _tmp136 = Scalar(1.0) / (_tmp135);
  const Scalar _tmp137 = _tmp105 + _tmp62;
  const Scalar _tmp138 = _tmp108 * _tmp137;
  const Scalar _tmp139 = Scalar(1.0) / (_tmp107 - _tmp138 - _tmp65);
  ...
  const Scalar _tmp146 = _tmp103 + _tmp117 * _tmp145 - _tmp118 * _tmp144;
  const Scalar _tmp147 = fh1 * (_tmp110 + _tmp92);
  ...
  const Scalar _tmp153 = _tmp106 * (_tmp105 - _tmp112 * _tmp126 - _tmp137 * _tmp152);
  ...
  const Scalar _tmp156 = _tmp108 * _tmp140;
  const Scalar _tmp157 = _tmp106 * (_tmp138 * _tmp140 + Scalar(1.0));
  ...
  const Scalar _tmp172 =
      _tmp121 * _tmp123 * _tmp78 + _tmp133 * _tmp134 * _tmp78 - _tmp171 * _tmp79 - _tmp83 * _tmp90;
  const Scalar _tmp173 = Scalar(1.0) / (_tmp172);
  const Scalar _tmp174 = _tmp140 * _tmp148;
  const Scalar _tmp175 = _tmp106 * _tmp123 * _tmp146 + _tmp106 * _tmp134 * _tmp151 +
                         _tmp106 * _tmp142 * _tmp90 + _tmp124 * _tmp153 - _tmp149 * _tmp174 +
                         _tmp155 * _tmp157;
  const Scalar _tmp176 = std::asinh(_tmp173 * _tmp175);
  const Scalar _tmp177 = Scalar(1.0) * _tmp176;
  const Scalar _tmp178 = std::pow(_tmp172, Scalar(-2));
  const Scalar _tmp179 = _tmp127 * _tmp178;
  const Scalar _tmp180 = _tmp140 * _tmp41;
  const Scalar _tmp181 =
      (_tmp173 * (-_tmp149 * _tmp180 - _tmp153 + _tmp157 * _tmp169) - _tmp175 * _tmp179) /
  ...
  const Scalar _tmp186 = Scalar(9.6622558468725703) * _tmp126;
  ...
  const Scalar _tmp197 = _tmp126 * _tmp196;
  const Scalar _tmp198 = (_tmp189 * (-_tmp152 - _tmp156 * _tmp169 + _tmp180) + _tmp190 * _tmp197) /
  ...
  _res(2, 0) = _tmp182 * (-Scalar(1.0) * _tmp181 * std::cosh(_tmp177) -
                          (-Scalar(0.1034955) * _tmp179 * _tmp183 +
                           _tmp184 * (-_tmp176 * _tmp187 - _tmp181 * _tmp182)) *
                              std::cosh(_tmp185)) +
               _tmp187 * (-std::sinh(_tmp177) - std::sinh(_tmp185));
  _res(3, 0) = -_tmp186 * (-std::sinh(_tmp195) - std::sinh(_tmp199)) +
               _tmp192 * (-Scalar(1.0) * _tmp198 * std::cosh(_tmp199) -
                          (Scalar(0.1034955) * _tmp193 * _tmp197 +
                           _tmp194 * (_tmp186 * _tmp191 - _tmp192 * _tmp198)) *
                              std::cosh(_tmp195));
