...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl10(
  ...
  const Scalar _tmp28 = _tmp17 * _tmp8;
  ...
  const Scalar _tmp34 = Scalar(0.20999999999999999) * _tmp15 + Scalar(0.20999999999999999) * _tmp23;
  const Scalar _tmp35 = _tmp12 + _tmp9;
  ...
  const Scalar _tmp46 = _tmp16 + _tmp20;
  ...
  const Scalar _tmp55 = Scalar(23.361089618893828) *
  ...
  const Scalar _tmp58 = _tmp24 + _tmp31;
  ...
  const Scalar _tmp67 = _tmp34 + _tmp52;
  const Scalar _tmp68 = Scalar(1.0) / (_tmp62 - _tmp66 - _tmp67);
  const Scalar _tmp69 = Scalar(1.0) * _tmp68;
  const Scalar _tmp70 = _tmp50 + Scalar(-4.8333311099999996);
  const Scalar _tmp71 = _tmp54 + Scalar(1.79662371);
  const Scalar _tmp72 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp73 = _tmp70 * _tmp72;
  const Scalar _tmp74 = _tmp60 + p_init1;
  const Scalar _tmp75 = _tmp74 + Scalar(8.3196563700000006);
  const Scalar _tmp76 = _tmp63 + p_init0;
  ...
  const Scalar _tmp82 = _tmp21 + _tmp45;
  const Scalar _tmp83 = _tmp47 * _tmp79;
  const Scalar _tmp84 = _tmp81 * (-_tmp79 * _tmp82 + _tmp83);
  const Scalar _tmp85 = _tmp81 * (-_tmp73 * _tmp83 + _tmp80 * _tmp82);
  const Scalar _tmp86 = _tmp47 * _tmp73 + _tmp73 * _tmp85;
  const Scalar _tmp87 = -_tmp47 - _tmp65 * _tmp86 + _tmp73 * _tmp84;
  const Scalar _tmp88 = _tmp58 + p_init1;
  const Scalar _tmp89 = _tmp88 + Scalar(-4.7752063900000001);
  const Scalar _tmp90 = _tmp67 + p_init0;
  ...
  const Scalar _tmp96 = _tmp47 * _tmp93;
  const Scalar _tmp97 = _tmp13 + _tmp46;
  const Scalar _tmp98 = -_tmp73 * _tmp96 - _tmp85 * _tmp95 + _tmp94 * _tmp97;
  const Scalar _tmp99 = -_tmp65 * _tmp98 - _tmp84 * _tmp95 - _tmp93 * _tmp97 + _tmp96;
  ...
  const Scalar _tmp104 = _tmp103 * (-_tmp102 * _tmp49 * _tmp71 + _tmp102 * _tmp53 * _tmp70);
  const Scalar _tmp105 = _tmp81 * (_tmp104 * _tmp79 + _tmp60 * _tmp79 - _tmp63 * _tmp80);
  const Scalar _tmp106 = _tmp104 * _tmp93 - _tmp105 * _tmp95 + _tmp58 * _tmp93 - _tmp67 * _tmp94;
  const Scalar _tmp107 = _tmp100 * _tmp106;
  const Scalar _tmp108 = Scalar(1.0) / (_tmp106);
  const Scalar _tmp109 = _tmp108 * _tmp99;
  const Scalar _tmp110 = _tmp109 * (-_tmp104 + _tmp105 * _tmp73 - _tmp107 * _tmp87);
  const Scalar _tmp111 = _tmp59 * _tmp68;
  const Scalar _tmp112 = _tmp110 + _tmp87;
  const Scalar _tmp113 = _tmp100 * _tmp98;
  const Scalar _tmp114 = _tmp110 * _tmp111 - _tmp112 * _tmp113 + _tmp86;
  const Scalar _tmp115 = Scalar(1.0) * _tmp61;
  const Scalar _tmp116 = _tmp40 + Scalar(-2.5202214700000001);
  const Scalar _tmp117 = _tmp33 + Scalar(8.3888750099999996);
  ...
  const Scalar _tmp121 = _tmp56 * _tmp65 + _tmp62;
  const Scalar _tmp122 = 0;
  const Scalar _tmp123 = _tmp121 * _tmp68;
  const Scalar _tmp124 = -_tmp113 * _tmp122 - _tmp123 * _tmp59 + _tmp57;
  const Scalar _tmp125 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp126 = _tmp59 * _tmp69;
  const Scalar _tmp127 = Scalar(1.0) * _tmp108;
  const Scalar _tmp128 = _tmp109 * _tmp126 - _tmp127 * _tmp98;
  const Scalar _tmp129 = _tmp109 * _tmp69;
  const Scalar _tmp130 = _tmp117 * _tmp118;
  const Scalar _tmp131 = fh1 * (-_tmp119 * _tmp32 + _tmp130 * _tmp39);
  const Scalar _tmp132 = _tmp66 * _tmp69 + Scalar(1.0);
  const Scalar _tmp133 = _tmp65 * _tmp69;
  const Scalar _tmp134 = _tmp22 * fh1;
  const Scalar _tmp135 = -_tmp130 * _tmp134 - Scalar(3.29616) * _tmp26 - _tmp32 * fv1;
  const Scalar _tmp136 = _tmp115 * _tmp64 * _tmp85 - Scalar(1.0) * _tmp84;
  const Scalar _tmp137 = _tmp109 * (-Scalar(1.0) * _tmp105 - _tmp107 * _tmp136);
  const Scalar _tmp138 = _tmp136 + _tmp137;
  const Scalar _tmp139 = _tmp111 * _tmp137 - _tmp113 * _tmp138 - Scalar(1.0) * _tmp85;
  const Scalar _tmp140 = _tmp130 * fh1;
  const Scalar _tmp141 = _tmp119 * _tmp134 + Scalar(3.29616) * _tmp35 + _tmp39 * fv1;
  const Scalar _tmp142 = _tmp100 * _tmp122;
  const Scalar _tmp143 = _tmp79 * _tmp81;
  const Scalar _tmp144 = _tmp143 * _tmp95;
  const Scalar _tmp145 = _tmp100 * _tmp93;
  const Scalar _tmp146 = _tmp100 * _tmp95;
  const Scalar _tmp147 = -_tmp112 * _tmp146 - _tmp73;
  const Scalar _tmp148 = -_tmp138 * _tmp146 + Scalar(1.0);
  const Scalar _tmp149 =
      -_tmp103 * _tmp120 * (_tmp112 * _tmp145 + _tmp143 * _tmp147 + Scalar(1.0)) -
      _tmp103 * _tmp125 * (-_tmp142 * _tmp144 + _tmp142 * _tmp93) -
      _tmp103 * _tmp131 * (-_tmp127 * _tmp144 + _tmp127 * _tmp93) -
      _tmp103 * _tmp140 * (_tmp138 * _tmp145 + _tmp143 * _tmp148);
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = std::asinh(
      _tmp150 * (Scalar(1.0) * _tmp120 * (_tmp110 * _tmp69 - _tmp114 * _tmp115) +
                 Scalar(1.0) * _tmp125 * (-_tmp115 * _tmp124 - _tmp121 * _tmp69 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp131 * (-_tmp115 * _tmp128 + _tmp129) +
                 Scalar(1.0) * _tmp135 * (-_tmp115 * _tmp132 + _tmp133) +
                 Scalar(1.0) * _tmp140 * (-_tmp115 * _tmp139 + _tmp137 * _tmp69) +
                 Scalar(1.0) * _tmp141 * (_tmp126 * _tmp61 - _tmp69)));
  ...
  const Scalar _tmp154 = _tmp125 * _tmp142;
  const Scalar _tmp155 = _tmp81 * _tmp95;
  const Scalar _tmp156 = _tmp127 * _tmp131;
  const Scalar _tmp157 = _tmp120 * _tmp147 * _tmp81 + _tmp140 * _tmp148 * _tmp81 -
                         _tmp154 * _tmp155 - _tmp155 * _tmp156;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 = _tmp141 * _tmp69;
  const Scalar _tmp160 =
      std::asinh(_tmp158 * (_tmp114 * _tmp120 * _tmp61 + _tmp124 * _tmp125 * _tmp61 +
                            _tmp128 * _tmp131 * _tmp61 + _tmp132 * _tmp135 * _tmp61 +
                            _tmp139 * _tmp140 * _tmp61 - _tmp159 * _tmp59 * _tmp61));
  const Scalar _tmp161 = Scalar(9.6622558468725703) * _tmp157;
  const Scalar _tmp162 = _tmp100 * fh1;
  const Scalar _tmp163 =
      _tmp112 * _tmp119 * _tmp162 + _tmp130 * _tmp138 * _tmp162 + _tmp154 + _tmp156;
  const Scalar _tmp164 = Scalar(1.0) / (_tmp163);
  const Scalar _tmp165 =
      std::asinh(_tmp164 * (-_tmp110 * _tmp120 * _tmp68 + _tmp123 * _tmp125 - _tmp129 * _tmp131 -
                            _tmp133 * _tmp135 - _tmp137 * _tmp140 * _tmp68 + _tmp159));
  ...
  _res(1, 0) =
      _tmp152 *
          (-std::sinh(Scalar(1.0) * _tmp151) -
           std::sinh(Scalar(0.1034955) * _tmp150 * (-_tmp151 * _tmp152 - std::sqrt(_tmp55)))) -
      Scalar(8.3700199099999999) *
          std::sqrt(Scalar(Scalar(0.01427404356387209) * _tmp55 +
  ...
  _res(2, 0) =
      _tmp161 *
          (-std::sinh(Scalar(1.0) * _tmp160) -
           std::sinh(Scalar(0.1034955) * _tmp158 * (-std::sqrt(_tmp153) - _tmp160 * _tmp161))) -
      Scalar(8.4718465799999993) *
          std::sqrt(Scalar(Scalar(0.013932974275675287) * _tmp153 +
                           std::pow(Scalar(-Scalar(0.11803802046660766) * _tmp82 -
  ...
  _res(3, 0) =
      ...
      Scalar(8.36416322) *
          std::sqrt(Scalar(Scalar(0.014294040284261563) * _tmp167 +
                           std::pow(Scalar(-Scalar(0.1195576860108189) * _tmp97 -
