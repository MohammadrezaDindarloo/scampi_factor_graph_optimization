...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl8(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp12 = _tmp2 * rot_init_z + _tmp4 * rot_init_x - _tmp6 * rx + _tmp8 * rot_init_w;
  const Scalar _tmp13 =
  ...
  const Scalar _tmp20 = 2 * _tmp12 * _tmp7;
  const Scalar _tmp21 = _tmp13 * _tmp9;
  const Scalar _tmp22 =
  ...
  const Scalar _tmp31 = _tmp13 * _tmp7;
  const Scalar _tmp32 =
      -Scalar(0.010999999999999999) * _tmp30 + Scalar(0.010999999999999999) * _tmp31;
  const Scalar _tmp33 = Scalar(0.20999999999999999) * _tmp11 + Scalar(0.20999999999999999) * _tmp14;
  ...
  const Scalar _tmp53 = Scalar(0.20999999999999999) * _tmp20 - Scalar(0.20999999999999999) * _tmp21;
  ...
  const Scalar _tmp58 = _tmp44 * _tmp57 - _tmp48 * _tmp55;
  const Scalar _tmp59 = _tmp50 * _tmp58;
  const Scalar _tmp60 = -_tmp49 * _tmp57 + _tmp55;
  const Scalar _tmp61 = _tmp50 * _tmp60;
  const Scalar _tmp62 = Scalar(1.0) * _tmp40 * _tmp59 - Scalar(1.0) * _tmp61;
  const Scalar _tmp63 = _tmp52 + _tmp56;
  const Scalar _tmp64 = _tmp29 + _tmp38;
  const Scalar _tmp65 = _tmp64 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp66 = _tmp15 + _tmp23;
  ...
  const Scalar _tmp72 = _tmp48 * _tmp70 - _tmp69;
  const Scalar _tmp73 = _tmp50 * _tmp72;
  const Scalar _tmp74 = -_tmp40 * (-_tmp48 * _tmp71 - _tmp58 * _tmp73 + _tmp63 * _tmp69) -
                        _tmp60 * _tmp73 - _tmp63 * _tmp70 + _tmp71;
  ...
  const Scalar _tmp78 = _tmp46 * _tmp76;
  const Scalar _tmp79 = _tmp78 * (_tmp26 * _tmp47 * _tmp77 - _tmp35 * _tmp45 * _tmp77);
  const Scalar _tmp80 = _tmp50 * (-_tmp24 * _tmp44 + _tmp39 * _tmp49 + _tmp49 * _tmp79);
  const Scalar _tmp81 = _tmp64 * _tmp70 - _tmp66 * _tmp69 + _tmp70 * _tmp79 - _tmp72 * _tmp80;
  const Scalar _tmp82 = _tmp75 * _tmp81;
  const Scalar _tmp83 = Scalar(1.0) / (_tmp81);
  const Scalar _tmp84 = _tmp74 * _tmp83;
  const Scalar _tmp85 = _tmp62 + _tmp84 * (-_tmp62 * _tmp82 - Scalar(1.0) * _tmp80);
  const Scalar _tmp86 = _tmp72 * _tmp75;
  const Scalar _tmp87 = -_tmp85 * _tmp86 + Scalar(1.0);
  const Scalar _tmp88 = _tmp49 * _tmp50;
  const Scalar _tmp89 = _tmp70 * _tmp75;
  const Scalar _tmp90 = _tmp16 + _tmp25;
  const Scalar _tmp91 = _tmp90 + p_init0 + Scalar(-2.5202214700000001);
  const Scalar _tmp92 = _tmp34 + _tmp37;
  ...
  const Scalar _tmp97 = -_tmp40 * (_tmp48 * _tmp54 + _tmp48 * _tmp59) + _tmp48 * _tmp61 - _tmp54;
  const Scalar _tmp98 = _tmp84 * (_tmp48 * _tmp80 - _tmp79 - _tmp82 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp48 - _tmp86 * _tmp98;
  const Scalar _tmp100 = _tmp91 * _tmp94;
  const Scalar _tmp101 = _tmp100 * fh1;
  const Scalar _tmp102 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp103 = _tmp27 + _tmp36 * _tmp40;
  const Scalar _tmp104 = 0;
  const Scalar _tmp105 = _tmp49 * _tmp73;
  const Scalar _tmp106 = Scalar(1.0) * _tmp83;
  const Scalar _tmp107 = fh1 * (-_tmp100 * _tmp92 + _tmp90 * _tmp95);
  ...
  _res(1, 0) = std::exp(_tmp101 * _tmp78 * (_tmp88 * _tmp99 + _tmp89 * _tmp98 + Scalar(1.0)) +
                        _tmp102 * _tmp78 * (-_tmp104 * _tmp105 + _tmp104 * _tmp70) +
                        _tmp107 * _tmp78 * (-_tmp105 * _tmp106 + _tmp106 * _tmp70) +
                        _tmp78 * _tmp96 * (_tmp85 * _tmp89 + _tmp87 * _tmp88));
  _res(2, 0) = std::exp(-_tmp101 * _tmp50 * _tmp99 + _tmp108 * _tmp73 + _tmp109 * _tmp73 -
                        _tmp50 * _tmp87 * _tmp96);
  _res(3, 0) = std::exp(-_tmp101 * _tmp75 * _tmp98 - _tmp108 - _tmp109 - _tmp75 * _tmp85 * _tmp96);
