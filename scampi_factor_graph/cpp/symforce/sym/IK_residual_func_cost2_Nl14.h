...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl14(
  ...
  const Scalar _tmp23 = 2 * _tmp12 * _tmp15;
  ...
  const Scalar _tmp31 = _tmp12 * _tmp16;
  ...
  const Scalar _tmp40 = Scalar(0.20999999999999999) * _tmp31 - Scalar(0.20999999999999999) * _tmp32;
  const Scalar _tmp41 =
  ...
  const Scalar _tmp70 = -_tmp40;
  const Scalar _tmp71 = _tmp67 + _tmp70;
  const Scalar _tmp72 = _tmp50 + _tmp55;
  ...
  const Scalar _tmp82 = -_tmp54 * _tmp81 + _tmp71 * _tmp79;
  const Scalar _tmp83 = Scalar(1.0) / (_tmp54 * _tmp80 - _tmp79);
  const Scalar _tmp84 = _tmp66 * _tmp83;
  const Scalar _tmp85 = _tmp43 + _tmp70;
  const Scalar _tmp86 = -_tmp54 * _tmp69 + _tmp65 * _tmp85 - _tmp82 * _tmp84;
  ...
  const Scalar _tmp94 = -_tmp64 * _tmp85 + _tmp69 - _tmp84 * _tmp93 - _tmp86 * _tmp92;
  ...
  const Scalar _tmp98 = _tmp49 * _tmp96;
  const Scalar _tmp99 = _tmp98 * (_tmp46 * _tmp53 * _tmp97 - _tmp48 * _tmp51 * _tmp97);
  const Scalar _tmp100 = _tmp72 * _tmp80 - _tmp75 * _tmp79 + _tmp80 * _tmp99;
  ...
  const Scalar _tmp104 = -_tmp100 * _tmp84 + _tmp56 * _tmp64 - _tmp60 * _tmp65 + _tmp64 * _tmp99;
  ...
  const Scalar _tmp110 = -_tmp109 * _tmp66 + Scalar(1.0);
  ...
  const Scalar _tmp117 = _tmp101 * _tmp106 * _tmp66;
  ...
  const Scalar _tmp121 = _tmp54 * _tmp83;
  const Scalar _tmp122 = _tmp121 * _tmp82 + _tmp54 * _tmp68;
  const Scalar _tmp123 = _tmp121 * _tmp93 - _tmp122 * _tmp92 - _tmp68;
  const Scalar _tmp124 = _tmp107 * (_tmp100 * _tmp121 - _tmp105 * _tmp123 - _tmp99);
  const Scalar _tmp125 = _tmp95 * (_tmp123 + _tmp124);
  const Scalar _tmp126 = -_tmp125 * _tmp66 - _tmp54;
  const Scalar _tmp127 = _tmp119 * fh1;
  const Scalar _tmp128 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp129 = _tmp87 * _tmp92 + _tmp90;
  const Scalar _tmp130 = 0;
  const Scalar _tmp131 = -_tmp116 * _tmp98 * (_tmp109 * _tmp64 + _tmp110 * _tmp111) -
                         _tmp120 * _tmp98 * (-_tmp117 * _tmp80 + _tmp118 * _tmp64) -
                         _tmp127 * _tmp98 * (_tmp111 * _tmp126 + _tmp125 * _tmp64 + Scalar(1.0)) -
                         _tmp128 * _tmp98 * (_tmp130 * _tmp64 - _tmp130 * _tmp80 * _tmp84);
  const Scalar _tmp132 = Scalar(1.0) / (_tmp131);
  const Scalar _tmp133 = _tmp56 + _tmp88;
  const Scalar _tmp134 = _tmp133 * _tmp92;
  const Scalar _tmp135 = Scalar(1.0) / (-_tmp134 - _tmp60 + _tmp90);
  const Scalar _tmp136 = Scalar(1.0) * _tmp135;
  const Scalar _tmp137 = _tmp134 * _tmp136 + Scalar(1.0);
  const Scalar _tmp138 = _tmp44 * fh1;
  const Scalar _tmp139 = -_tmp115 * _tmp138 - Scalar(3.29616) * _tmp21 - _tmp27 * fv1;
  const Scalar _tmp140 = _tmp133 * _tmp135;
  const Scalar _tmp141 = -_tmp101 * _tmp82 + _tmp108 * _tmp140 - _tmp109 * _tmp86;
  const Scalar _tmp142 = _tmp119 * _tmp138 + Scalar(3.29616) * _tmp33 + _tmp37 * fv1;
  const Scalar _tmp143 = _tmp133 * _tmp89;
  const Scalar _tmp144 = _tmp129 * _tmp135;
  const Scalar _tmp145 = -_tmp130 * _tmp86 - _tmp133 * _tmp144 + _tmp88;
  const Scalar _tmp146 = _tmp107 * _tmp136;
  const Scalar _tmp147 = -_tmp118 * _tmp86 + _tmp133 * _tmp146;
  const Scalar _tmp148 = _tmp122 + _tmp124 * _tmp140 - _tmp125 * _tmp86;
  const Scalar _tmp149 = std::asinh(
      _tmp132 * (Scalar(1.0) * _tmp116 * (-_tmp102 * _tmp141 + _tmp108 * _tmp136) +
                 Scalar(1.0) * _tmp120 * (-_tmp102 * _tmp147 + _tmp146) +
                 Scalar(1.0) * _tmp127 * (-_tmp102 * _tmp148 + _tmp124 * _tmp136) +
                 Scalar(1.0) * _tmp128 * (-_tmp102 * _tmp145 - _tmp129 * _tmp136 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp139 * (-_tmp102 * _tmp137 + _tmp136 * _tmp92) +
                 Scalar(1.0) * _tmp142 * (_tmp136 * _tmp143 - _tmp136)));
  const Scalar _tmp150 = Scalar(9.6622558468725703) * _tmp131;
  ...
  const Scalar _tmp153 = _tmp128 * _tmp130;
  const Scalar _tmp154 = _tmp110 * _tmp116 * _tmp83 - _tmp117 * _tmp120 +
                         _tmp126 * _tmp127 * _tmp83 - _tmp153 * _tmp84;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 = _tmp136 * _tmp142;
  const Scalar _tmp157 = _tmp139 * _tmp89;
  const Scalar _tmp158 =
      std::asinh(_tmp155 * (_tmp116 * _tmp141 * _tmp89 + _tmp120 * _tmp147 * _tmp89 +
                            _tmp127 * _tmp148 * _tmp89 + _tmp128 * _tmp145 * _tmp89 +
                            _tmp137 * _tmp157 - _tmp143 * _tmp156));
  const Scalar _tmp159 = Scalar(9.6622558468725703) * _tmp154;
  ...
  const Scalar _tmp161 = _tmp109 * _tmp116 + _tmp118 * _tmp120 + _tmp125 * _tmp127 + _tmp153;
  const Scalar _tmp162 = Scalar(1.0) / (_tmp161);
  const Scalar _tmp163 = std::asinh(_tmp162 * (-_tmp108 * _tmp116 * _tmp135 - _tmp120 * _tmp146 -
                                               _tmp124 * _tmp127 * _tmp135 + _tmp128 * _tmp144 -
                                               _tmp136 * _tmp157 * _tmp91 + _tmp156));
  ...
  _res(1, 0) =
      _tmp150 *
          (-std::sinh(Scalar(1.0) * _tmp149) -
           std::sinh(Scalar(0.1034955) * _tmp132 * (-_tmp149 * _tmp150 - std::sqrt(_tmp151)))) -
  ...
  _res(2, 0) =
      _tmp159 *
          (-std::sinh(Scalar(1.0) * _tmp158) -
           std::sinh(Scalar(0.1034955) * _tmp155 * (-std::sqrt(_tmp152) - _tmp158 * _tmp159))) -
