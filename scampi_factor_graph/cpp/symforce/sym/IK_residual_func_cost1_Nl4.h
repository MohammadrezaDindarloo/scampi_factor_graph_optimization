...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl4(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp11 = 2 * _tmp10 * _tmp9;
  const Scalar _tmp12 =
      _tmp4 * rot_init_z + _tmp6 * rot_init_x - _tmp7 * rot_init_y + _tmp8 * rot_init_w;
  const Scalar _tmp13 = 2 * _tmp4 * rot_init_w - 2 * _tmp6 * rot_init_y - 2 * _tmp7 * rot_init_x -
                        2 * _tmp8 * rot_init_z;
  ...
  const Scalar _tmp23 = 1 - 2 * std::pow(_tmp12, Scalar(2));
  ...
  const Scalar _tmp30 = _tmp10 * _tmp17;
  ...
  const Scalar _tmp35 = Scalar(0.20999999999999999) * _tmp23 + Scalar(0.20999999999999999) * _tmp34;
  ...
  const Scalar _tmp42 = -Scalar(0.010999999999999999) * _tmp22 -
                        Scalar(0.010999999999999999) * _tmp34 + Scalar(-0.010999999999999999);
  const Scalar _tmp43 = Scalar(0.20999999999999999) * _tmp30 - Scalar(0.20999999999999999) * _tmp31;
  ...
  const Scalar _tmp65 = _tmp16 + _tmp46;
  ...
  const Scalar _tmp76 = _tmp62 * _tmp63;
  const Scalar _tmp77 = -_tmp57 * _tmp76 + _tmp60 * _tmp64 + _tmp64 * _tmp75;
  const Scalar _tmp78 = _tmp67 * _tmp73;
  const Scalar _tmp79 = Scalar(1.0) / (_tmp64 * _tmp78 - _tmp76);
  const Scalar _tmp80 = _tmp55 * _tmp78 - _tmp56;
  const Scalar _tmp81 = _tmp79 * _tmp80;
  const Scalar _tmp82 = _tmp47 * _tmp55 - _tmp51 * _tmp56 + _tmp55 * _tmp75 - _tmp77 * _tmp81;
  ...
  const Scalar _tmp87 = _tmp27 + Scalar(8.3196563700000006);
  const Scalar _tmp88 = _tmp38 + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp92 = fh1 * (-_tmp26 * _tmp90 + _tmp37 * _tmp91);
  ...
  const Scalar _tmp98 = -_tmp64 * _tmp97 + _tmp76 * _tmp96;
  const Scalar _tmp99 = _tmp40 + _tmp95;
  const Scalar _tmp100 = -_tmp55 * _tmp97 + _tmp56 * _tmp99 - _tmp81 * _tmp98;
  const Scalar _tmp101 = Scalar(1.0) * _tmp65;
  const Scalar _tmp102 = -_tmp101;
  const Scalar _tmp103 = Scalar(1.0) / (_tmp102 + _tmp60);
  const Scalar _tmp104 = Scalar(1.0) * _tmp68;
  const Scalar _tmp105 = _tmp103 * (_tmp104 - _tmp57);
  const Scalar _tmp106 = _tmp64 * _tmp94 - _tmp64 * _tmp96;
  const Scalar _tmp107 = -_tmp100 * _tmp105 - _tmp106 * _tmp81 + _tmp55 * _tmp94 - _tmp55 * _tmp99;
  ...
  const Scalar _tmp112 = _tmp64 * _tmp79;
  const Scalar _tmp113 = _tmp108 * _tmp80;
  const Scalar _tmp114 = _tmp110 * _tmp113;
  const Scalar _tmp115 = _tmp78 * _tmp79;
  const Scalar _tmp116 = _tmp115 * _tmp98 + _tmp97;
  const Scalar _tmp117 = -_tmp105 * _tmp116 + _tmp106 * _tmp115 - _tmp94;
  const Scalar _tmp118 = _tmp108 * _tmp82;
  const Scalar _tmp119 = _tmp107 * _tmp83;
  const Scalar _tmp120 = _tmp119 * (_tmp115 * _tmp77 - _tmp117 * _tmp118 - _tmp75);
  const Scalar _tmp121 = _tmp117 + _tmp120;
  const Scalar _tmp122 = _tmp108 * _tmp55;
  const Scalar _tmp123 = -_tmp113 * _tmp121 - _tmp78;
  const Scalar _tmp124 = _tmp90 * fh1;
  const Scalar _tmp125 = _tmp85 * _tmp98;
  const Scalar _tmp126 = _tmp105 * _tmp125 - _tmp106 * _tmp85;
  const Scalar _tmp127 = _tmp119 * (-_tmp118 * _tmp126 - _tmp77 * _tmp85);
  const Scalar _tmp128 = _tmp126 + _tmp127;
  const Scalar _tmp129 = -_tmp113 * _tmp128 + Scalar(1.0);
  const Scalar _tmp130 = _tmp91 * fh1;
  const Scalar _tmp131 = -_tmp124 * _tmp74 * (_tmp112 * _tmp123 + _tmp121 * _tmp122 + Scalar(1.0)) -
                         _tmp130 * _tmp74 * (_tmp112 * _tmp129 + _tmp122 * _tmp128) -
                         _tmp74 * _tmp92 * (_tmp55 * _tmp84 - _tmp64 * _tmp86) -
                         _tmp74 * _tmp93 * (_tmp111 * _tmp55 - _tmp112 * _tmp114);
  const Scalar _tmp132 = Scalar(1.0) / (_tmp131);
  const Scalar _tmp133 = _tmp45 * fh1;
  const Scalar _tmp134 = -_tmp133 * _tmp91 - Scalar(3.29616) * _tmp20 - _tmp26 * fv1;
  const Scalar _tmp135 = _tmp102 + _tmp47;
  const Scalar _tmp136 = _tmp105 * _tmp135;
  const Scalar _tmp137 = Scalar(1.0) / (_tmp104 - _tmp136 - _tmp51);
  ...
  const Scalar _tmp141 = _tmp105 * _tmp138;
  const Scalar _tmp142 = _tmp109 * _tmp137;
  const Scalar _tmp143 = _tmp100 * _tmp108;
  const Scalar _tmp144 = _tmp103 * (_tmp102 - _tmp110 * _tmp143 - _tmp135 * _tmp142);
  const Scalar _tmp145 = _tmp135 * _tmp137;
  const Scalar _tmp146 = -_tmp125 + _tmp127 * _tmp145 - _tmp128 * _tmp143;
  const Scalar _tmp147 = _tmp133 * _tmp90 + Scalar(3.29616) * _tmp32 + _tmp37 * fv1;
  const Scalar _tmp148 = _tmp103 * _tmp135;
  const Scalar _tmp149 = _tmp116 + _tmp120 * _tmp145 - _tmp121 * _tmp143;
  const Scalar _tmp150 = _tmp119 * _tmp138;
  const Scalar _tmp151 = -_tmp100 * _tmp84 + _tmp135 * _tmp150;
  const Scalar _tmp152 =
      std::asinh(_tmp132 * (Scalar(1.0) * _tmp124 * (_tmp120 * _tmp138 - _tmp140 * _tmp149) +
                            Scalar(1.0) * _tmp130 * (_tmp127 * _tmp138 - _tmp140 * _tmp146) +
                            Scalar(1.0) * _tmp134 * (-_tmp139 * _tmp140 + _tmp141) +
                            Scalar(1.0) * _tmp147 * (_tmp138 * _tmp148 - _tmp138) +
                            Scalar(1.0) * _tmp92 * (-_tmp140 * _tmp151 + _tmp150) +
                            Scalar(1.0) * _tmp93 *
                                (-_tmp109 * _tmp138 - Scalar(1.0) * _tmp144 + Scalar(1.0))));
  const Scalar _tmp153 = Scalar(9.6622558468725703) * _tmp131;
  const Scalar _tmp154 = -_tmp114 * _tmp79 * _tmp93 + _tmp123 * _tmp124 * _tmp79 +
                         _tmp129 * _tmp130 * _tmp79 - _tmp86 * _tmp92;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 = _tmp138 * _tmp147;
  const Scalar _tmp157 =
      std::asinh(_tmp155 * (_tmp103 * _tmp124 * _tmp149 + _tmp103 * _tmp130 * _tmp146 +
                            _tmp103 * _tmp134 * _tmp139 + _tmp103 * _tmp151 * _tmp92 +
                            _tmp144 * _tmp93 - _tmp148 * _tmp156));
  const Scalar _tmp158 = Scalar(9.6622558468725703) * _tmp154;
  const Scalar _tmp159 = _tmp108 * _tmp121 * _tmp124 + _tmp108 * _tmp128 * _tmp130 +
                         _tmp111 * _tmp93 + _tmp84 * _tmp92;
  const Scalar _tmp160 = Scalar(1.0) / (_tmp159);
  const Scalar _tmp161 =
      std::asinh(_tmp160 * (-_tmp120 * _tmp124 * _tmp137 - _tmp127 * _tmp130 * _tmp137 -
                            _tmp134 * _tmp141 + _tmp142 * _tmp93 - _tmp150 * _tmp92 + _tmp156));
  ...
  _res(2, 0) =
      -_tmp158 *
          (Scalar(0.87653584775870996) * _tmp155 + std::cosh(Scalar(1.0) * _tmp157) -
           std::cosh(
