...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl18(
  ...
  const Scalar _tmp48 = -_tmp22 * _tmp47 + _tmp32 * _tmp35 + _tmp35 * _tmp46;
  ...
  const Scalar _tmp52 = Scalar(0.20999999999999999) * _tmp27 + Scalar(0.20999999999999999) * _tmp28;
  const Scalar _tmp53 = -_tmp52;
  const Scalar _tmp54 =
      -Scalar(0.010999999999999999) * _tmp24 - Scalar(0.010999999999999999) * _tmp8;
  const Scalar _tmp55 = Scalar(0.20999999999999999) * _tmp14 - Scalar(0.20999999999999999) * _tmp16;
  const Scalar _tmp56 = _tmp54 + _tmp55;
  const Scalar _tmp57 = _tmp53 + _tmp56;
  const Scalar _tmp58 = _tmp53 + _tmp54 - _tmp55;
  const Scalar _tmp59 = _tmp35 * _tmp58;
  const Scalar _tmp60 = -_tmp35 * _tmp57 + _tmp59;
  const Scalar _tmp61 = _tmp47 * _tmp57 - _tmp49 * _tmp59;
  const Scalar _tmp62 = Scalar(1.0) * _tmp40;
  const Scalar _tmp63 = Scalar(1.0) * _tmp37;
  const Scalar _tmp64 = (-_tmp22 + _tmp63) / (_tmp32 - _tmp62);
  const Scalar _tmp65 = -_tmp51 * _tmp60 + _tmp51 * _tmp61 * _tmp64;
  const Scalar _tmp66 = _tmp25 + _tmp31;
  const Scalar _tmp67 = _tmp66 + p_init1 + Scalar(-4.7752063900000001);
  const Scalar _tmp68 = _tmp17 + _tmp20;
  ...
  const Scalar _tmp74 = _tmp49 * _tmp72 - _tmp73;
  const Scalar _tmp75 = _tmp50 * _tmp74;
  const Scalar _tmp76 = _tmp58 * _tmp72;
  const Scalar _tmp77 = _tmp52 + _tmp56;
  const Scalar _tmp78 = -_tmp60 * _tmp75 -
                        _tmp64 * (-_tmp49 * _tmp76 - _tmp61 * _tmp75 + _tmp73 * _tmp77) -
                        _tmp72 * _tmp77 + _tmp76;
  const Scalar _tmp79 = Scalar(1.0) / (_tmp78);
  const Scalar _tmp80 = _tmp46 * _tmp72 - _tmp48 * _tmp75 + _tmp66 * _tmp72 - _tmp69 * _tmp73;
  const Scalar _tmp81 = _tmp79 * _tmp80;
  const Scalar _tmp82 = Scalar(1.0) / (_tmp80);
  const Scalar _tmp83 = _tmp78 * _tmp82;
  const Scalar _tmp84 = _tmp65 + _tmp83 * (-_tmp48 * _tmp51 - _tmp65 * _tmp81);
  const Scalar _tmp85 = _tmp72 * _tmp79;
  const Scalar _tmp86 = _tmp74 * _tmp79;
  const Scalar _tmp87 = -_tmp84 * _tmp86 + Scalar(1.0);
  const Scalar _tmp88 = _tmp35 * _tmp50;
  const Scalar _tmp89 = _tmp25 + _tmp39;
  const Scalar _tmp90 = _tmp89 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp91 = _tmp36 + _tmp68;
  ...
  _res(0, 0) = 0;
  _res(1, 0) = -_tmp107 *
               std::exp(_tmp100 * _tmp95 * (_tmp85 * _tmp98 + _tmp88 * _tmp99 + Scalar(1.0)) +
                        _tmp102 * _tmp45 * (-_tmp101 * _tmp35 * _tmp75 + _tmp101 * _tmp72) +
                        _tmp103 * _tmp107 + _tmp94 * _tmp95 * (_tmp84 * _tmp85 + _tmp87 * _tmp88));
  _res(2, 0) = -_tmp106 * std::exp(-_tmp100 * _tmp109 * _tmp99 + _tmp108 * _tmp75 -
                                   _tmp109 * _tmp87 * _tmp94 + _tmp110 * _tmp75);
  _res(3, 0) = _tmp105 * std::exp(-_tmp100 * _tmp111 * _tmp98 - _tmp108 - _tmp110 -
