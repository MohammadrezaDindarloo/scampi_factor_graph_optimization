...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl18(
  ...
  const Scalar _tmp102 = _tmp35 * _tmp75;
  const Scalar _tmp103 = fh1 * (-_tmp100 * _tmp89 + _tmp91 * _tmp94);
  const Scalar _tmp104 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp105 = _tmp62 * _tmp64 + _tmp63;
  const Scalar _tmp106 = 0;
  const Scalar _tmp107 = _tmp104 * _tmp106;
  const Scalar _tmp108 = _tmp50 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp95 * (_tmp85 * _tmp98 + _tmp88 * _tmp99 + Scalar(1.0)) +
                        _tmp103 * _tmp45 * (-_tmp101 * _tmp102 + _tmp101 * _tmp72) +
                        _tmp104 * _tmp45 * (-_tmp102 * _tmp106 + _tmp106 * _tmp72) +
                        _tmp94 * _tmp95 * (_tmp84 * _tmp85 + _tmp87 * _tmp88));
  _res(2, 0) = std::exp(-_tmp100 * _tmp108 * _tmp99 + _tmp107 * _tmp75 - _tmp108 * _tmp87 * _tmp94 +
                        _tmp109 * _tmp75);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp110 * _tmp98 - _tmp107 - _tmp109 - _tmp110 * _tmp84 * _tmp94);
