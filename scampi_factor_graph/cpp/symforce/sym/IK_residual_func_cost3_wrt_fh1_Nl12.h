...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl12(
  ...
  const Scalar _tmp44 = Scalar(0.20999999999999999) * _tmp28 - Scalar(0.20999999999999999) * _tmp29;
  const Scalar _tmp45 = -_tmp44;
  const Scalar _tmp46 =
      -Scalar(0.010999999999999999) * _tmp19 - Scalar(0.010999999999999999) * _tmp26;
  const Scalar _tmp47 = Scalar(0.20999999999999999) * _tmp16 + Scalar(0.20999999999999999) * _tmp17;
  const Scalar _tmp48 = _tmp46 - _tmp47;
  const Scalar _tmp49 = _tmp45 + _tmp48;
  const Scalar _tmp50 = _tmp35 * _tmp49;
  const Scalar _tmp51 = _tmp45 + _tmp46 + _tmp47;
  ...
  const Scalar _tmp57 = _tmp13 + _tmp36;
  ...
  const Scalar _tmp63 = -_tmp43 * _tmp62 + _tmp53 * _tmp60;
  const Scalar _tmp64 = Scalar(1.0) / (_tmp43 * _tmp61 - _tmp60);
  const Scalar _tmp65 = _tmp35 * _tmp43 - _tmp52;
  const Scalar _tmp66 = _tmp64 * _tmp65;
  const Scalar _tmp67 = Scalar(1.0) * _tmp37;
  const Scalar _tmp68 = Scalar(1.0) * _tmp40;
  const Scalar _tmp69 = (-_tmp55 + _tmp68) / (_tmp57 - _tmp67);
  const Scalar _tmp70 = -_tmp53 * _tmp61 + _tmp62;
  const Scalar _tmp71 = -_tmp35 * _tmp51 + _tmp50 - _tmp66 * _tmp70 -
                        _tmp69 * (-_tmp43 * _tmp50 + _tmp51 * _tmp52 - _tmp63 * _tmp66);
  ...
  const Scalar _tmp75 = _tmp42 * _tmp73;
  const Scalar _tmp76 = _tmp75 * (-_tmp37 * _tmp41 * _tmp74 + _tmp38 * _tmp40 * _tmp74);
  const Scalar _tmp77 = -_tmp55 * _tmp60 + _tmp57 * _tmp61 + _tmp61 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) * _tmp64;
  const Scalar _tmp79 = _tmp63 * _tmp69 * _tmp78 - _tmp70 * _tmp78;
  const Scalar _tmp80 = _tmp23 * _tmp35 - _tmp32 * _tmp52 + _tmp35 * _tmp76 - _tmp66 * _tmp77;
  const Scalar _tmp81 = _tmp72 * _tmp80;
  const Scalar _tmp82 = Scalar(1.0) / (_tmp80);
  const Scalar _tmp83 = _tmp71 * _tmp82;
  const Scalar _tmp84 = _tmp79 + _tmp83 * (-_tmp77 * _tmp78 - _tmp79 * _tmp81);
  const Scalar _tmp85 = _tmp72 * _tmp84;
  const Scalar _tmp86 = _tmp65 * _tmp72;
  const Scalar _tmp87 = -_tmp84 * _tmp86 + Scalar(1.0);
  const Scalar _tmp88 = _tmp61 * _tmp64;
  const Scalar _tmp89 = _tmp13 + _tmp22;
  const Scalar _tmp90 = _tmp89 + p_init1 + Scalar(-4.7752063900000001);
  const Scalar _tmp91 = _tmp25 + _tmp54;
  ...
  const Scalar _tmp95 = _tmp75 * _tmp94 * (_tmp35 * _tmp85 + _tmp87 * _tmp88);
  const Scalar _tmp96 = _tmp92 * _tmp93;
  const Scalar _tmp97 = -_tmp89 * _tmp96 + _tmp91 * _tmp94;
  const Scalar _tmp98 = Scalar(1.0) * _tmp82;
  const Scalar _tmp99 = _tmp61 * _tmp66;
  const Scalar _tmp100 = _tmp75 * _tmp97 * (_tmp35 * _tmp98 - _tmp98 * _tmp99);
  const Scalar _tmp101 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp102 = _tmp67 * _tmp69 + _tmp68;
  const Scalar _tmp103 = 0;
  const Scalar _tmp104 = _tmp43 * _tmp64;
  const Scalar _tmp105 = _tmp104 * _tmp70 - _tmp49 - _tmp69 * (_tmp104 * _tmp63 + _tmp43 * _tmp49);
  const Scalar _tmp106 = _tmp105 + _tmp83 * (_tmp104 * _tmp77 - _tmp105 * _tmp81 - _tmp76);
  const Scalar _tmp107 = -_tmp106 * _tmp86 - _tmp43;
  const Scalar _tmp108 = _tmp106 * _tmp72;
  const Scalar _tmp109 = _tmp75 * _tmp96 * (_tmp107 * _tmp88 + _tmp108 * _tmp35 + Scalar(1.0));
  const Scalar _tmp110 = _tmp101 * _tmp103;
  const Scalar _tmp111 = _tmp64 * _tmp87 * _tmp94;
  const Scalar _tmp112 = _tmp97 * _tmp98;
  const Scalar _tmp113 = _tmp112 * fh1;
  const Scalar _tmp114 = _tmp107 * _tmp64 * _tmp96;
  const Scalar _tmp115 = _tmp108 * _tmp96;
  const Scalar _tmp116 = _tmp85 * _tmp94;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp100 - _tmp109 - _tmp95) *
               std::exp(_tmp100 * fh1 + _tmp101 * _tmp75 * (_tmp103 * _tmp35 - _tmp103 * _tmp99) +
                        _tmp109 * fh1 + _tmp95 * fh1);
  _res(2, 0) = -(_tmp111 - _tmp112 * _tmp66 + _tmp114) *
               std::exp(_tmp110 * _tmp66 - _tmp111 * fh1 + _tmp113 * _tmp66 - _tmp114 * fh1);
  _res(3, 0) =
      -(_tmp112 + _tmp115 + _tmp116) * std::exp(-_tmp110 - _tmp113 - _tmp115 * fh1 - _tmp116 * fh1);
